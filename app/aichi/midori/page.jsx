...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.kodomo-navi.com/aichi/midori' },
  openGraph: {
    title: '名古屋市緑区の子供の習い事おすすめ｜コドモならいごと',
    description: '愛知県名古屋市緑区の子ども向け習い事教室を口コミ・料金で比較。',
    url: 'https://www.kodomo-navi.com/aichi/midori',
  },
};
