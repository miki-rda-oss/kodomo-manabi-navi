...
export const metadata = {
  title: '愛知県の子供向けダンス教室・習い事一覧｜コドモならいごと',
  description: '愛知県内のキッズダンス教室・子ども向け習い事を市区別に比較。名古屋市・豊田・日進など主要エリアの教室情報を掲載。',
  keywords: ['愛知', '子供', 'ダンス教室', '習い事', 'キッズ', '名古屋', '比較'],
  alternates: {
    canonical: 'https://www.kodomo-navi.com/aichi',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "愛知県の習い事", "item": "https://www.kodomo-navi.com/aichi" },
  ],
};
...
const collectionSchema = {
  "@context": "https://schema.org",
  "@type": "CollectionPage",
  "name": "愛知県の子供向け習い事・ダンス教室一覧",
  "url": "https://www.kodomo-navi.com/aichi",
  "description": "愛知県内のキッズダンス教室・子ども向け習い事を市区別に比較。名古屋市・豊田・日進など主要エリアの教室情報を掲載。",
  "breadcrumb": {
    "@type": "BreadcrumbList",
    "itemListElement": [
...
const areas = [
  { slug: 'anjo', name: '安城市' },
  { slug: 'moriyama', name: '名古屋市守山区' },
  { slug: 'nisshin', name: '日進市' },
  { slug: 'owariasahi', name: '尾張旭市' },
  { slug: 'tenpaku', name: '名古屋市天白区' },
  { slug: 'toyota', name: '豊田市' },
];

const faqs = [
  { q: '愛知県内の子供ダンス教室の月謝相場は？', a: '愛知県の子供ダンス教室は月4,500円〜7,500円程度が相場です。名古屋市内は交通の便が良く、通いやすい立地の教室が多いです。' },
  { q: '名古屋市でおすすめの子供ダンス教室は？', a: '名古屋市内はリディアダンスアカデミー（守山区・天白区）のほか多数の教室が展開しています。各エリアページでご確認ください。' },
  { q: '愛知県で豊田市・日進市の習い事情報はありますか？', a: 'はい。豊田市・日進市・安城市・尾張旭市の習い事情報を掲載しています。車での送迎が多い地域特性を踏まえた駐車場完備教室も紹介しています。' },
  { q: '愛知でダンス以外の習い事情報はありますか？', a: 'はい。スイミング・英語・ピアノ・プログラミングなど幅広い習い事情報を愛知各エリアで掲載中です。' },
];

const blogs = [
  { href: '/blog/aichi-kids-dance-school-ranking', text: '愛知・名古屋で子供のダンス教室おすすめ10選【2026年版】' },
...
const otherPrefs = [
  { href: '/osaka', name: '大阪府' },
  { href: '/gifu', name: '岐阜県' },
  { href: '/nagano', name: '長野県' },
  { href: '/shiga', name: '滋賀県' },
];

const faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"愛知県内の子供ダンス教室の月謝相場は？","acceptedAnswer":{"@type":"Answer","text":"愛知県の子供ダンス教室は月4,500円〜7,500円程度が相場です。名古屋市内は交通の便が良く、通いやすい立地の教室が多いです。"}},{"@type":"Question","name":"名古屋市でおすすめの子供ダンス教室は？","acceptedAnswer":{"@type":"Answer","text":"名古屋市内はリディアダンスアカデミー（守山区・天白区）のほか多数の教室が展開しています。各エリアページでご確認ください。"}},{"@type":"Question","name":"愛知県で豊田市・日進市の習い事情報はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。豊田市・日進市・安城市・尾張旭市の習い事情報を掲載しています。車での送迎が多い地域特性を踏まえた駐車場完備教室も紹介しています。"}},{"@type":"Question","name":"愛知でダンス以外の習い事情報はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。スイミング・英語・ピアノ・プログラミングなど幅広い習い事情報を愛知各エリアで掲載中です。"}}]};

export default function AichiPrefPage() {
  return (
    <div style={{ fontFamily: "'Noto Sans JP','Hiragino Sans',sans-serif", background: "#f4f7fc", minHeight: "100vh" }}>
      ...
      <header style={{ background: "#fff", borderBottom: "1px solid #e8edf4", boxShadow: "0 2px 8px rgba(0,0,0,.05)", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", gap: 10, height: 56 }}>
          ...
          <span style={{ fontSize: 13, color: "#888", fontWeight: 600 }}>愛知県</span>
        </div>
      </header>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A, #2a4070)", padding: "44px 24px 40px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 900, color: "#fff", marginBottom: 12 }}>愛知県の子供向け<br />ダンス教室・習い事</h1>
          <p style={{ fontSize: 14, color: "rgba(255,255,255,.85)", lineHeight: 1.9 }}>
            名古屋を中心とする愛知でお子さまの習い事を探そう<br />
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12 }}>
            {areas.map((area) => (
              <Link key={area.slug} href={`/aichi/${area.slug}`} style={{ display: "block", background: "#fff", border: "1.5px solid #e8edf4", borderRadius: 12, padding: "16px 18px", textDecoration: "none", color: "#1B2A4A", fontWeight: 700, fontSize: 15, boxShadow: "0 2px 8px rgba(0,0,0,.04)" }}>
        ...
        <section style={{ maxWidth: 900, margin: "0 auto 40px", padding: "0 0px" }}>
          <div style={{ background: "linear-gradient(135deg, #fff7ee, #fff0f5)", borderRadius: 16, padding: "24px 20px", border: "1.5px solid #FFD9A0" }}>
            <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 12 }}>
              🥇 愛知の習い事トレンド2026：ダンスが1位
            </h2>
            <p style={{ fontSize: 14, lineHeight: 1.9, color: "#444", marginBottom: 16 }}>
              愛知・名古屋でキッズダンス教室が増加中。K-POPブームと中学校ダンス必修化の影響で、愛知でも子供のダンス習い事への需要が急増しています。
              2026年の習い事人気ランキングでダンスが1位を獲得し、スイミングや英語を上回る勢いです。
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {[
                { slug: "aichi-nagoya-kids-dance-2026", title: "愛知・名古屋キッズダンス2026年ガイド" },
                { slug: "aichi-kids-dance-school", title: "愛知おすすめキッズダンス教室" },
              ].map(({ slug, title }) => (
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/aichi', '⚽', 'サッカー'],
              ['/piano/aichi', '🎹', 'ピアノ'],
              ['/swimming/aichi', '🏊', 'スイミング'],
              ['/english/aichi', '🌍', '英語'],
              ['/ballet/aichi', '🩰', 'バレエ'],
              ['/gymnastics/aichi', '🤸', '体操'],
              ['/basketball/aichi', '🏀', 'バスケット'],
              ['/preschool/aichi', '🧒', '幼児教室'],
              ['/soroban/aichi', '🧮', 'そろばん'],
              ['/programming/aichi', '💻', 'プログラミング'],
              ['/rhythmics/aichi', '🎵', 'リトミック'],
              ['/music/aichi', '🎸', '音楽'],
              ['/karate/aichi', '🥋', '空手'],
