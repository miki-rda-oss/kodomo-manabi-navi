...
const breadcrumbSchema = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"秋田県の習い事","item":"https://www.kodomo-navi.com/akita"}]};
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/akita', '⚽', 'サッカー'],
              ['/piano/akita', '🎹', 'ピアノ'],
              ['/swimming/akita', '🏊', 'スイミング'],
              ['/english/akita', '🌍', '英語'],
              ['/ballet/akita', '🩰', 'バレエ'],
              ['/gymnastics/akita', '🤸', '体操'],
              ['/basketball/akita', '🏀', 'バスケット'],
              ['/preschool/akita', '🧒', '幼児教室'],
              ['/soroban/akita', '🧮', 'そろばん'],
              ['/programming/akita', '💻', 'プログラミング'],
              ['/rhythmics/akita', '🎵', 'リトミック'],
              ['/music/akita', '🎸', '音楽'],
              ['/karate/akita', '🥋', '空手'],
