...
const breadcrumbSchema = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"青森県の習い事","item":"https://www.kodomo-navi.com/aomori"}]};
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/aomori', '⚽', 'サッカー'],
              ['/piano/aomori', '🎹', 'ピアノ'],
              ['/swimming/aomori', '🏊', 'スイミング'],
              ['/english/aomori', '🌍', '英語'],
              ['/ballet/aomori', '🩰', 'バレエ'],
              ['/gymnastics/aomori', '🤸', '体操'],
              ['/basketball/aomori', '🏀', 'バスケット'],
              ['/preschool/aomori', '🧒', '幼児教室'],
              ['/soroban/aomori', '🧮', 'そろばん'],
              ['/programming/aomori', '💻', 'プログラミング'],
              ['/rhythmics/aomori', '🎵', 'リトミック'],
              ['/music/aomori', '🎸', '音楽'],
              ['/karate/aomori', '🥋', '空手'],
