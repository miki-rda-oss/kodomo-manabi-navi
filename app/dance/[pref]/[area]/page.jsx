  ...
  return (
    <div style={{ fontFamily: "'Noto Sans JP','Hiragino Sans',sans-serif", background: "#f4f7fc", minHeight: "100vh" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "WebPage",
        "@id": `https://www.kodomo-navi.com/dance/${pref}/${area}`,
        "name": `${data.prefName}${data.name}の子供向けダンス教室おすすめ`,
        "description": `${data.prefName}${data.name}の子ども向けダンス教室を比較。月謝・口コミ・無料体験情報を掲載。`,
        "url": `https://www.kodomo-navi.com/dance/${pref}/${area}`,
        "inLanguage": "ja",
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "ItemList",
        "name": `${data.prefName}${data.name}の子供ダンス教室おすすめ一覧`,
        "url": `https://www.kodomo-navi.com/dance/${pref}/${area}`,
