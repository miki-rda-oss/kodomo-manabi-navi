...
export const metadata = {
  title: '福岡県の子供向けダンス教室・習い事一覧｜コドモならいごと',
  description: '福岡県内のキッズダンス教室・子ども向け習い事を比較。福岡市 など主要エリアの教室情報を掲載。',
  keywords: ['福岡', '子供', 'ダンス教室', '習い事'],
  alternates: { canonical: 'https://www.kodomo-navi.com/fukuoka' },
};
export default function PrefPage() {
  const breadcrumb = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"福岡県の習い事","item":"https://www.kodomo-navi.com/fukuoka"}]};
  const faq = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"福岡県内の子供ダンス教室の月謝相場は？","acceptedAnswer":{"@type":"Answer","text":"福岡県の子供ダンス教室は月5,000円〜8,000円程度が相場です。リディアダンスアカデミーは月会員プランが5,500円〜です。"}},{"@type":"Question","name":"福岡県で3歳から通えるダンス教室はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。福岡県内のダンス教室の多くが3歳から入会できるリトルクラスを設けています。"}},{"@type":"Question","name":"福岡県の人気ダンス教室はどこですか？","acceptedAnswer":{"@type":"Answer","text":"リディアダンスアカデミーをはじめ、福岡県には体験レッスン無料の人気教室が多数あります。"}}]};
  return (
    <div style={{fontFamily:"'Noto Sans JP',sans-serif",background:"#f4f7fc",minHeight:"100vh"}}>
      ...
      <header style={{background:"#fff",borderBottom:"1px solid #e8edf4",position:"sticky",top:0,zIndex:100}}>
        <div style={{maxWidth:1100,margin:"0 auto",padding:"0 24px",display:"flex",alignItems:"center",gap:10,height:56}}>
          ...
          <span style={{color:"#ddd"}}>›</span><span style={{fontSize:13,color:"#888"}}>福岡県</span>
        </div>
      </header>
      <nav style={{maxWidth:1100,margin:"0 auto",padding:"10px 24px",fontSize:12,color:"#888"}}>
        <Link href="/" style={{color:"#FF8A00",textDecoration:"none"}}>トップ</Link>{" › "}福岡県
      </nav>
      <section style={{background:"linear-gradient(135deg,#1B2A4A,#2a4070)",padding:"44px 24px 40px"}}>
        <div style={{maxWidth:800,margin:"0 auto",textAlign:"center"}}>
          <h1 style={{fontSize:28,fontWeight:900,color:"#fff",marginBottom:12}}>福岡県の子供向け<br/>ダンス教室・習い事</h1>
          <p style={{fontSize:14,color:"rgba(255,255,255,.85)",lineHeight:1.9}}>福岡市を中心に福岡県全域の習い事情報を掲載。お子さまにぴったりの教室を見つけよう。</p>
        </div>
      </section>
      <div style={{maxWidth:900,margin:"0 auto",padding:"32px 24px 60px"}}>
        <div style={{background:"#fff",borderRadius:18,padding:"28px 24px",marginBottom:24,border:"1.5px solid #e8edf4"}}>
          <h2 style={{fontSize:18,fontWeight:900,color:"#1B2A4A",marginBottom:16}}>📍 福岡県のエリアを選ぶ</h2>
          <p style={{fontSize:14,color:"#666",lineHeight:1.9}}>福岡県内の市区町村別の習い事情報を準備中です。まずはリディアダンスアカデミーの無料体験をお試しください。</p>
        </div>
        <div style={{background:"linear-gradient(135deg,#1B2A4A,#2a4070)",borderRadius:18,padding:"28px 24px",marginBottom:24,textAlign:"center"}}>
          ...
          <p style={{fontSize:13,color:"rgba(255,255,255,.85)",lineHeight:1.8,marginBottom:20}}>全国100校以上展開・現役プロダンサー講師200名以上。3歳から通えるリトルクラス充実。初回体験無料！</p>
        ...
        <div style={{background:"#fff",borderRadius:18,padding:"28px 24px",marginBottom:24,border:"1.5px solid #e8edf4"}}>
          ...
          <Link href="/blog/kids-dance-brain-development-science" style={{display:"block",padding:"10px 0",borderBottom:"1px solid #f0f0f0",color:"#1B2A4A",textDecoration:"none",fontSize:14}}>子供のダンスが脳発達に効果的な科学的理由</Link>
        ...
        <section style={{marginBottom:40}}>
          <div style={{background:"linear-gradient(135deg,#fff7ee,#fff0f5)",borderRadius:16,padding:"24px 20px",border:"1.5px solid #FFD9A0"}}>
            <h2 style={{fontSize:18,fontWeight:900,color:"#1B2A4A",marginBottom:12}}>🥇 福岡県の習い事トレンド2026：ダンスが1位</h2>
            <p style={{fontSize:14,lineHeight:1.9,color:"#444"}}>K-POPブームと中学校ダンス必修化の影響で、福岡県でも子供のダンス習い事への需要が急増。2026年ランキングでダンスが1位を獲得しました。</p>
          </div>
        </section>
        <div style={{background:"#fff",borderRadius:18,padding:"28px 24px",marginBottom:24,border:"1.5px solid #e8edf4"}}>
        ...
        <section style={{background:'#fff',borderRadius:16,padding:'24px 20px',border:'1.5px solid #e8edf4',marginTop:32,marginBottom:24}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
            {[
              ['/soccer/fukuoka','⚽','サッカー'],
              ['/piano/fukuoka','🎹','ピアノ'],
              ['/swimming/fukuoka','🏊','スイミング'],
              ['/english/fukuoka','🌍','英語'],
              ['/ballet/fukuoka','🩰','バレエ'],
              ['/gymnastics/fukuoka','🤸','体操'],
              ['/basketball/fukuoka','🏀','バスケット'],
              ['/preschool/fukuoka','🧒','幼児教室'],
              ['/soroban/fukuoka','🧮','そろばん'],
              ['/programming/fukuoka','💻','プログラミング'],
              ['/rhythmics/fukuoka','🎵','リトミック'],
              ['/music/fukuoka','🎸','音楽'],
              ['/karate/fukuoka','🥋','空手'],
