...
const breadcrumbSchema = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"福島県の習い事","item":"https://www.kodomo-navi.com/fukushima"}]};
const faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"福島県内の子供ダンス教室の月謝相場は？","acceptedAnswer":{"@type":"Answer","text":"福島県の子供ダンス教室は月5,000円〜8,000円程度が相場です。"}},{"@type":"Question","name":"福島県で3歳から通えるダンス教室はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。福島県内のダンス教室の多くが3歳から入会できるリトルクラスを設けています。"}},{"@type":"Question","name":"福島県の人気ダンス教室はどこですか？","acceptedAnswer":{"@type":"Answer","text":"リディアダンスアカデミーをはじめ、福島県には体験レッスン無料の人気ダンス教室が多数あります。"}}]};
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/fukushima', '⚽', 'サッカー'],
              ['/piano/fukushima', '🎹', 'ピアノ'],
              ['/swimming/fukushima', '🏊', 'スイミング'],
              ['/english/fukushima', '🌍', '英語'],
              ['/ballet/fukushima', '🩰', 'バレエ'],
              ['/gymnastics/fukushima', '🤸', '体操'],
              ['/basketball/fukushima', '🏀', 'バスケット'],
              ['/preschool/fukushima', '🧒', '幼児教室'],
              ['/soroban/fukushima', '🧮', 'そろばん'],
              ['/programming/fukushima', '💻', 'プログラミング'],
              ['/rhythmics/fukushima', '🎵', 'リトミック'],
              ['/music/fukushima', '🎸', '音楽'],
              ['/karate/fukushima', '🥋', '空手'],
