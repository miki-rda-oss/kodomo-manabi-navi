...
const SCHOOLS = {
  ...
  soccer: [
    {
      id: "s1", name: "リベルタサッカースクール", featured: true,
      rating: 4.3, reviews: 520, age: "3歳〜12歳", fee: "7,103円〜",
      location: "全国1,000校以上",
      desc: "「認める・褒める・励ます」の指導方針で全国No.1の規模。元プロ選手コーチが技術とメンタルを育成。初心者歓迎で3歳から始められる。",
      tags: ["全国1,000校", "無料体験あり", "3歳〜OK", "初心者歓迎", "元プロ指導"],
      genres: ["ヒップホップ", "ストリート", "フリースタイル"],
      badge: "全国No.1規模", badgeColor: "#FF8A00",
    },
    {
      id: "s2", name: "ガンバ大阪スクール",
      rating: 4.5, reviews: 310, age: "年少〜小6", fee: "6,600円〜",
      location: "大阪・兵庫・京都を中心に展開",
      desc: "Jリーグ・ガンバ大阪が運営する公式スクール。プロの指導メソッドで基礎から応用まで楽しく学べる。",
      tags: ["Jリーグ直営", "無料体験あり", "プロメソッド", "体系的指導"],
      genres: ["パス", "ドリブル", "シュート"],
      badge: "Jリーグ直営", badgeColor: "#2E7D32",
    },
    {
      id: "s3", name: "コパ・カフェサッカースクール",
      rating: 4.2, reviews: 185, age: "3歳〜小学生", fee: "6,600円〜",
      location: "全国展開中",
      desc: "楽しむことを最優先にしたサッカースクール。試合経験を積みながら自然にテクニックを習得。",
      tags: ["楽しむ重視", "無料体験あり", "試合多数", "初心者OK"],
      genres: ["ドリブル", "パス", "ゲーム形式"],
      badge: "楽しさ重視", badgeColor: "#4CAF50",
    },
    {
      id: "s4", name: "FCバルセロナスクール",
      rating: 4.5, reviews: 142, age: "4歳〜12歳", fee: "15,400円〜",
      location: "東京・大阪・名古屋・福岡",
      desc: "バルサの哲学に基づいた技術・戦術指導。ポジショニングや判断力を重視した世界基準の育成プログラム。",
      tags: ["世界基準", "無料体験あり", "バルサメソッド", "戦術指導"],
      genres: ["パス", "ポジショニング", "戦術"],
      badge: "世界基準", badgeColor: "#1B2A4A",
    },
    {
      id: "s5", name: "浦和レッズハートフルクラブ",
      rating: 4.6, reviews: 98, age: "年少〜小6", fee: "7,150円〜",
      location: "埼玉・東京・千葉",
      desc: "浦和レッズが運営するハートフルサッカー。技術だけでなく心の成長も大切にした指導。フェアプレー精神を育む。",
      tags: ["Jリーグ直営", "無料体験あり", "心の成長", "フェアプレー"],
      genres: ["テクニック", "フェアプレー", "チームワーク"],
      badge: "心の成長", badgeColor: "#E53935",
    },
  ],
  english: [
    {
      id: "e1", name: "ECCジュニア", featured: true,
      rating: 4.4, reviews: 890, age: "0歳〜", fee: "7,150円〜",
      location: "全国8,000教室",
      desc: "国内最大級の英会話教室。外国人講師とのコミュニケーションを通じて自然に英語力を習得。英検対策コースも充実。",
      tags: ["全国8,000教室", "無料体験あり", "英検対策", "外国人講師", "全年齢対応"],
      genres: ["スピーキング", "リスニング", "英検対策", "フォニックス"],
      badge: "国内最大級", badgeColor: "#FF8A00",
    },
    {
      id: "e2", name: "Kids Duo（キッズデュオ）",
      rating: 4.6, reviews: 312, age: "1歳〜小6", fee: "55,000円〜/月",
      location: "全国130校以上",
      desc: "英語のみで生活する全英語環境の学童・幼稚園型スクール。遊びながら自然に英語が身につくイマージョン教育。",
      tags: ["全英語環境", "無料体験あり", "イマージョン", "学童併設"],
      genres: ["日常英語", "スピーキング", "リスニング"],
      badge: "全英語環境", badgeColor: "#1B2A4A",
    },
    {
      id: "e3", name: "ECC KIDS",
      rating: 4.4, reviews: 425, age: "1歳半〜", fee: "9,900円〜",
      location: "全国展開",
      desc: "All Englishの環境で自然に英語が身につく。外国人講師とバイリンガル講師のペアティーチングが好評。",
      tags: ["All English", "無料体験あり", "ペア指導", "幼児から対応"],
      genres: ["スピーキング", "フォニックス", "リスニング"],
      badge: "All English", badgeColor: "#FF8A00",
    },
    {
      id: "e4", name: "シェーン英会話",
      rating: 4.3, reviews: 278, age: "2歳〜", fee: "7,700円〜",
      location: "全国120校以上",
      desc: "ネイティブ講師による少人数制。英国式メソッドで4技能をバランスよく習得。週1回から通える柔軟なコース設定。",
      tags: ["ネイティブ講師", "無料体験あり", "少人数制", "英国式メソッド"],
      genres: ["4技能", "スピーキング", "ライティング"],
      badge: "英国式", badgeColor: "#2196F3",
    },
    {
      id: "e5", name: "ベルリッツ Kids",
      rating: 4.5, reviews: 198, age: "3歳〜", fee: "12,100円〜",
      location: "全国40校以上",
      desc: "130年以上の歴史を持つ世界最大の語学学校のキッズコース。厳選されたネイティブ講師が楽しく英語を指導。",
      tags: ["世界最大語学学校", "無料体験あり", "ネイティブ専任", "少人数制"],
      genres: ["英会話", "スピーキング", "リスニング"],
      badge: "世界No.1語学校", badgeColor: "#E53935",
    },
  ],
  piano: [
    {
      id: "pi1", name: "ヤマハ音楽教室", featured: true,
      rating: 4.5, reviews: 1240, age: "0歳〜", fee: "6,600円〜",
      location: "全国7,000教室以上",
      desc: "国内最大の音楽教室。グループレッスンで楽しく音楽の基礎を習得。0歳から始めるおんがくなかよしコースから本格コースまで充実。",
      tags: ["全国7,000教室", "無料体験あり", "0歳〜OK", "発表会充実", "グループ・個人選択可"],
      genres: ["ピアノ", "エレクトーン", "音楽の基礎", "ソルフェージュ"],
      badge: "国内最大", badgeColor: "#FF8A00",
    },
    {
      id: "pi2", name: "カワイ音楽教室",
      rating: 4.4, reviews: 876, age: "0歳〜", fee: "5,500円〜",
      location: "全国4,000教室以上",
      desc: "ヤマハと並ぶ二大音楽教室。独自のドレミファソラシドメソッドで音楽の楽しさを伝える。個人レッスンが充実。",
      tags: ["全国4,000教室", "無料体験あり", "個人レッスン充実", "発表会あり"],
      genres: ["ピアノ", "音感育成", "ソルフェージュ"],
      badge: "二大教室", badgeColor: "#9C27B0",
    },
    {
      id: "pi3", name: "EYS音楽教室",
      rating: 4.4, reviews: 542, age: "3歳〜", fee: "8,800円〜",
      location: "東京・大阪・名古屋・オンライン",
      desc: "入会時に楽器プレゼントが人気のサービス。マンツーマンレッスンで一人ひとりのペースに合わせた指導。振替制度が充実。",
      tags: ["楽器プレゼント", "無料体験あり", "マンツーマン", "振替自由"],
      genres: ["ピアノ", "ポップス", "クラシック"],
      badge: "楽器プレゼント", badgeColor: "#E91E63",
    },
    {
      id: "pi4", name: "シアーミュージック",
      rating: 4.5, reviews: 387, age: "3歳〜", fee: "8,800円〜",
      location: "全国200校以上",
      desc: "好きな曲から始められるカリキュラムが人気。クラシックからポップスまで自分のペースで楽しく上達できる。",
      tags: ["好きな曲OK", "無料体験あり", "全国200校", "マンツーマン"],
      genres: ["ピアノ", "ポップス", "J-POP", "クラシック"],
      badge: "好きな曲から", badgeColor: "#FF5722",
    },
    {
      id: "pi5", name: "島村楽器 音楽教室",
      rating: 4.3, reviews: 298, age: "2歳〜", fee: "5,500円〜",
      location: "全国200店舗以上",
      desc: "楽器店併設の音楽教室。上質な環境でレッスンを受けられ、楽器購入もスムーズ。グループ・個人選択可能。",
      tags: ["楽器店併設", "無料体験あり", "グループ個人選択可", "全国200店"],
      genres: ["ピアノ", "クラシック", "ポップス"],
      badge: "楽器店直営", badgeColor: "#607D8B",
    },
  ],
};
