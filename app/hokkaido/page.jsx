      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:"32px 24px 60px"}}>
        ...
        <section style={{background:'#fff',borderRadius:16,padding:'24px 20px',border:'1.5px solid #e8edf4',marginTop:32,marginBottom:24}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
            {[
              ['/soccer/hokkaido','⚽','サッカー'],
              ['/piano/hokkaido','🎹','ピアノ'],
              ['/swimming/hokkaido','🏊','スイミング'],
              ['/english/hokkaido','🌍','英語'],
              ['/ballet/hokkaido','🩰','バレエ'],
              ['/gymnastics/hokkaido','🤸','体操'],
              ['/basketball/hokkaido','🏀','バスケット'],
              ['/preschool/hokkaido','🧒','幼児教室'],
              ['/soroban/hokkaido','🧮','そろばん'],
              ['/programming/hokkaido','💻','プログラミング'],
              ['/rhythmics/hokkaido','🎵','リトミック'],
              ['/music/hokkaido','🎸','音楽'],
              ['/karate/hokkaido','🥋','空手'],
