...
export const metadata = {
  title: '茨城県の子供向けダンス教室・習い事一覧｜コドモならいごと',
...
const faqs = [
  { q: '茨城県内の子供ダンス教室の月謝相場は？', a: '茨城県の子供ダンス教室は月4,000円〜7,000円程度が相場です。都心に比べてリーズナブルな教室が多い傾向があります。' },
  { q: '水戸市でおすすめの子供ダンス教室は？', a: '水戸市はリディアダンスアカデミーをはじめ複数の教室が展開しています。常磐線沿いに通いやすい立地の教室が集まっています。' },
  { q: 'つくば市の子供ダンス教室情報はありますか？', a: 'はい。つくば市はTXつくば駅周辺を中心に習い事教室の情報を掲載しています。研究学園都市として子育て環境が整った地域です。' },
  { q: '茨城県北部（日立・ひたちなか）の習い事情報は？', a: 'はい。日立市・ひたちなか市のダンス教室・習い事情報も掲載しています。各エリアページをご確認ください。' },
];

const blogs = [
  { href: '/blog/ibaraki-kids-dance-school-ranking', text: '茨城で子供のダンス教室おすすめランキング【2026年版】' },
    ...
    <div style={{ fontFamily: "'Noto Sans JP','Hiragino Sans',sans-serif", background: "#f4f7fc", minHeight: "100vh" }}>
      ...
      <header style={{ background: "#fff", borderBottom: "1px solid #e8edf4", boxShadow: "0 2px 8px rgba(0,0,0,.05)", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", gap: 10, height: 56 }}>
          ...
          <span style={{ fontSize: 13, color: "#888", fontWeight: 600 }}>茨城県</span>
        </div>
      </header>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A, #2a4070)", padding: "44px 24px 40px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 900, color: "#fff", marginBottom: 12 }}>茨城県の子供向け<br />ダンス教室・習い事</h1>
          <p style={{ fontSize: 14, color: "rgba(255,255,255,.85)", lineHeight: 1.9 }}>
            水戸・つくばを擁する茨城でお子さまの習い事を探そう<br />
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 18, paddingBottom: 12, borderBottom: "2px solid #FF8A0020" }}>📍 茨城県のエリアを選ぶ</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12 }}>
            {areas.map((area) => (
              <Link key={area.slug} href={`/ibaraki/${area.slug}`} style={{ display: "block", background: "#fff", border: "1.5px solid #e8edf4", borderRadius: 12, padding: "16px 18px", textDecoration: "none", color: "#1B2A4A", fontWeight: 700, fontSize: 15, boxShadow: "0 2px 8px rgba(0,0,0,.04)" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 18, paddingBottom: 12, borderBottom: "2px solid #FF8A0020" }}>❓ よくある質問（茨城の習い事）</h2>
        ...
        <section style={{ maxWidth: 900, margin: "0 auto 40px", padding: "0 0px" }}>
          <div style={{ background: "linear-gradient(135deg, #fff7ee, #fff0f5)", borderRadius: 16, padding: "24px 20px", border: "1.5px solid #FFD9A0" }}>
            <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 12 }}>
              🥇 茨城の習い事トレンド2026：ダンスが1位
            </h2>
            <p style={{ fontSize: 14, lineHeight: 1.9, color: "#444", marginBottom: 16 }}>
              茨城・つくばでダンス教室が増加。K-POPブームと中学校ダンス必修化の影響で、茨城でも子供のダンス習い事への需要が急増しています。
              2026年の習い事人気ランキングでダンスが1位を獲得し、スイミングや英語を上回る勢いです。
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {[
                { slug: "kids-dance-start-age-guide-2026", title: "子供のダンス習い事を始める年齢ガイド2026" },
              ].map(({ slug, title }) => (
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/ibaraki', '⚽', 'サッカー'],
              ['/piano/ibaraki', '🎹', 'ピアノ'],
              ['/swimming/ibaraki', '🏊', 'スイミング'],
              ['/english/ibaraki', '🌍', '英語'],
              ['/ballet/ibaraki', '🩰', 'バレエ'],
              ['/gymnastics/ibaraki', '🤸', '体操'],
              ['/basketball/ibaraki', '🏀', 'バスケット'],
              ['/preschool/ibaraki', '🧒', '幼児教室'],
              ['/soroban/ibaraki', '🧮', 'そろばん'],
              ['/programming/ibaraki', '💻', 'プログラミング'],
              ['/rhythmics/ibaraki', '🎵', 'リトミック'],
              ['/music/ibaraki', '🎸', '音楽'],
              ['/karate/ibaraki', '🥋', '空手'],
