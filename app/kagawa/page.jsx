...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.kodomo-navi.com/kagawa' },
};
        ...
        <section style={{background:'#fff',borderRadius:16,padding:'24px 20px',border:'1.5px solid #e8edf4',marginTop:32,marginBottom:24}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
            {[
              ['/soccer/kagawa','⚽','サッカー'],
              ['/piano/kagawa','🎹','ピアノ'],
              ['/swimming/kagawa','🏊','スイミング'],
              ['/english/kagawa','🌍','英語'],
              ['/ballet/kagawa','🩰','バレエ'],
              ['/gymnastics/kagawa','🤸','体操'],
              ['/basketball/kagawa','🏀','バスケット'],
              ['/preschool/kagawa','🧒','幼児教室'],
              ['/soroban/kagawa','🧮','そろばん'],
              ['/programming/kagawa','💻','プログラミング'],
              ['/rhythmics/kagawa','🎵','リトミック'],
              ['/music/kagawa','🎸','音楽'],
              ['/karate/kagawa','🥋','空手'],
