...
const S = {
  "ダンス": [
    { id:"d0",name:"リディアダンスアカデミー",rating:4.8,rc:45,age:"3歳〜15歳",featured:true,url:"https://re-dia.jp/takatsu/",
      desc:"初心者クラスが充実した3歳から学べるキッズダンススクール。現役プロダンサー講師200名以上在籍。全国100校以上展開。川崎市高津区に2校。",
      ...
      locs:[{n:"高津校",ad:"川崎市高津区溝口3丁目",st:"高津駅より徒歩3分",url:"https://re-dia.jp/takatsu/"},{n:"溝口校",ad:"川崎市高津区溝口1丁目",st:"溝の口駅より徒歩3分",url:"https://re-dia.jp/mizonokuchi/"}],
      revs:[{g:"女の子",a:"5歳〜",l:"高津校",t:"先生たちはみんな優しくて毎週楽しみに通っています。ダンスだけでなく人としても成長しました。"},{g:"女の子",a:"8歳〜",l:"溝口校",t:"DANCEを始めてから人前で堂々と自分の思いを伝えられるようになりました。"}],
      color:"#E53935",emoji:"🏆"},
    { id:"dx7",name:"NAYUTAS",rating:4.4,rc:38,age:"3歳〜大人",desc:"ボイス・ダンス・楽器の総合スクール。全国150校以上展開。川崎市高津区に1校展開中。",courses:[{n:"ダンスコース",p:null,a:"3歳〜"},{n:"ボイスコース",p:null,a:"3歳〜"}],locs:[{n:"NAYUTAS溝の口校",ad:"神奈川県川崎市高津区久本3-1-31 ユーランド溝ノ口ビル8F",st:"溝の口駅より徒歩3分"}],revs:[{g:"女の子",a:"5歳〜",l:"NAYUTAS溝の口校",t:"ダンスもボーカルも同じ場所で学べて、子どもが楽しく通っています。先生が優しいです。"}],color:"#0288D1",emoji:"🎵"},
  ],
  "サッカー": [
    { id:"s1",name:"フロンターレサッカースクール",rating:4.3,rc:65,age:"4歳〜15歳",desc:"プロの指導メソッドで基礎から応用まで楽しく学べます。",courses:[{n:"キッズ",p:4400,a:"4歳〜6歳"},{n:"ジュニア",p:7700,a:"6歳〜12歳"}],locs:[{n:"高津校",ad:"川崎市高津区下作延",st:"溝の口駅よりバス10分"}],revs:[{g:"男の子",a:"5歳〜",l:"高津校",t:"コーチの指導が丁寧で基礎技術がしっかり身につきました。"}],color:"#4CAF50",emoji:"⚽"},
    { id:"s2",name:"リベルタサッカースクール",rating:4.1,rc:12,age:"3歳〜12歳",desc:"「認める・褒める・励ます」の指導方針。元プロ選手コーチが技術とメンタルを育成。",courses:[{n:"通常コース",p:7103,a:"3歳〜12歳"}],locs:[{n:"川崎市高津区校",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩8分"}],revs:[{g:"男の子",a:"5歳〜",l:"川崎市高津区校",t:"上手な子に刺激を受けて頑張るようになりました。"}],color:"#FF9800",emoji:"🏃"},
  ],
  "英語・英会話": [
    { id:"e1",name:"ECC KIDS",rating:4.4,rc:180,age:"1歳半〜",desc:"All Englishの環境で自然に英語が身につく。外国人講師とバイリンガル講師のペアティーチング。",courses:[{n:"ミニキッズ",p:9900,a:"1歳半〜3歳"},{n:"小学生コース",p:11000,a:"6歳〜12歳"}],locs:[{n:"川崎市高津区校",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩3分"}],revs:[{g:"女の子",a:"4歳〜",l:"川崎市高津区校",t:"外国人の先生と楽しく英語を話せるようになりました。"}],color:"#FF6F00",emoji:"🌍"},
    { id:"e2",name:"シェーン英会話",rating:4.3,rc:95,age:"2歳〜",desc:"ネイティブ講師による少人数制。英国式メソッドで4技能をバランスよく習得。",courses:[{n:"年中・年長",p:11000,a:"4歳〜6歳"},{n:"小学生",p:11000,a:"6歳〜12歳"}],locs:[{n:"川崎市高津区校",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩3分"}],revs:[{g:"男の子",a:"5歳〜",l:"川崎市高津区校",t:"ネイティブの先生の発音を聞いて育つので発音がきれいです。"}],color:"#2196F3",emoji:"📚"},
  ],
  "ピアノ": [
    { id:"p1",name:"ヤマハ音楽教室",rating:4.5,rc:210,age:"1歳〜",desc:"「きく→うたう→ひく→よむ→つくる」で総合的な音楽力を育てる老舗教室。",courses:[{n:"幼児科",p:7700,a:"4歳〜5歳"},{n:"ジュニアスクール ピアノ",p:8800,a:"小学生"}],locs:[{n:"川崎市高津区センター",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩5分"}],revs:[{g:"女の子",a:"4歳〜",l:"川崎市高津区センター",t:"友達と楽しく学べています。音感がとても良くなりました。"}],color:"#FF5722",emoji:"🎹"},
    { id:"p2",name:"カワイ音楽教室",rating:4.3,rc:155,age:"3歳〜",desc:"「音楽で一人ひとりの個性を導き出す」教育理念。個人レッスン中心。",courses:[{n:"ピアノコース",p:8250,a:"4歳〜"}],locs:[{n:"川崎市高津区教室",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩5分"}],revs:[{g:"女の子",a:"5歳〜",l:"川崎市高津区教室",t:"個人レッスンでしっかり教えていただけるので上達が早いです。"}],color:"#E91E63",emoji:"🎶"},
  ],
  "スイミング": [
    { id:"sw1",name:"コナミスポーツクラブ",rating:4.3,rc:95,age:"6ヶ月〜15歳",desc:"段階的な進級制度で着実にステップアップ。ベビーから選手コースまで。",courses:[{n:"ベビー",p:6600,a:"6ヶ月〜3歳"},{n:"キッズ",p:8250,a:"3歳〜15歳"}],locs:[{n:"川崎市高津区店",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩5分"}],revs:[{g:"男の子",a:"4歳〜",l:"川崎市高津区店",t:"水が苦手だった息子がクロール25m泳げるようになりました。"}],color:"#03A9F4",emoji:"🏊"},
  ],
  "バレエ": [
    { id:"b1",name:"川崎市高津区バレエスタジオ",rating:4.4,rc:30,age:"3歳〜",desc:"川崎市高津区の地域密着型バレエ教室。アットホームな雰囲気で初心者でも安心。",courses:[{n:"プレバレエ",p:6600,a:"3歳〜5歳"},{n:"ジュニア",p:7700,a:"小学生"}],locs:[{n:"川崎市高津区スタジオ",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩5分"}],revs:[{g:"女の子",a:"5歳〜",l:"川崎市高津区スタジオ",t:"先生が優しくて楽しく通えています。姿勢が良くなりました。"}],color:"#9C27B0",emoji:"🩰"},
  ],
  "空手": [
    { id:"k1",name:"極真会館 川崎市高津区道場",rating:4.5,rc:35,age:"4歳〜",desc:"世界最大の空手団体。礼儀作法と強い心を育てる伝統的な空手教育。",courses:[{n:"少年部",p:7700,a:"4歳〜12歳"}],locs:[{n:"川崎市高津区道場",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩5分"}],revs:[{g:"男の子",a:"5歳〜",l:"川崎市高津区道場",t:"礼儀正しくなり粘り強さが身につきました。"}],color:"#F44336",emoji:"🥋"},
  ],
  "K-POP": [
    { id:"kp0",name:"リディアダンスアカデミー",rating:4.8,rc:45,age:"3歳〜15歳",featured:true,url:"https://re-dia.jp/takatsu/",
      desc:"K-POPダンスクラスも充実！最新の楽曲で楽しくダンス。プロ講師200名以上在籍、全国100校以上。川崎市高津区に2校。",
      tags:["K-POPクラス充実","全国100校以上","プロ講師200名以上","初回体験無料","少人数制"],
      genres:["K-POP","ヒップホップ","ジャズ","ロック","ブレイクダンス","ポップ","ワック"],
      courses:[{n:"リトルクラス",p:6600,a:"3歳〜6歳"},{n:"キッズクラス",p:7700,a:"小学生"},{n:"月会員プラン",p:7700,a:"全年齢"},{n:"受け放題プラン",p:27000,a:"全年齢"}],
      locs:[{n:"高津校",ad:"川崎市高津区溝口3丁目",st:"高津駅より徒歩3分",url:"https://re-dia.jp/takatsu/"},{n:"溝口校",ad:"川崎市高津区溝口1丁目",st:"溝の口駅より徒歩3分",url:"https://re-dia.jp/mizonokuchi/"}],
      revs:[{g:"女の子",a:"8歳〜",l:"高津校",t:"K-POPの曲で踊れるのがとても楽しい！毎週通うのが楽しみです。"},{g:"女の子",a:"10歳〜",l:"溝口校",t:"推しの振付を本格的に学べて最高！基礎もしっかり身につきました。"}],
      color:"#E53935",emoji:"🏆"},
  ],
  "リトミック": [
    { id:"rt1",name:"カワイ リトミック教室",rating:4.4,rc:88,age:"1歳〜",desc:"音楽の力で感性と表現力を育む。ピアノの生演奏で楽しく身体を動かします。",courses:[{n:"1歳クラス",p:5500,a:"1歳"},{n:"2歳クラス",p:5500,a:"2歳"}],locs:[{n:"川崎市高津区教室",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩5分"}],revs:[{g:"女の子",a:"1歳〜",l:"川崎市高津区教室",t:"音楽に合わせて体を動かすのが楽しそう。リズム感がついてきました。"}],color:"#FF7043",emoji:"🎵"},
  ],
  "幼児教室": [
    { id:"yj1",name:"ベビーパーク",rating:4.4,rc:95,age:"0歳〜3歳",desc:"「叱らない育児」で知られる親子教室。IQ140以上を目指す独自の知育プログラム。",courses:[{n:"Aクラス",p:15400,a:"0歳〜"}],locs:[{n:"川崎市高津区教室",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩3分"}],revs:[{g:"男の子",a:"0歳〜",l:"川崎市高津区教室",t:"親子で楽しく学べています。言葉の発達がとても早くなりました。"}],color:"#FF8A65",emoji:"🧒"},
  ],
  "学習塾": [
    { id:"gk1",name:"公文式教室",rating:4.3,rc:250,age:"3歳〜",desc:"自学自習で「ちょうどの学習」。一人ひとりのペースで基礎学力を鍛えます。",courses:[{n:"算数・数学",p:7700,a:"3歳〜"},{n:"国語",p:7700,a:"3歳〜"}],locs:[{n:"川崎市高津区駅前教室",ad:"神奈川県川崎市高津区",st:"最寄駅より徒歩2分"}],revs:[{g:"男の子",a:"5歳〜",l:"川崎市高津区駅前教室",t:"自分のペースで進められるので無理なく学力がつきました。"}],color:"#1E88E5",emoji:"📝"},
    { id:"gk2",name:"日能研",rating:4.5,rc:90,age:"小1〜",desc:"圧倒的な合格実績を誇る進学塾。",courses:[{n:"受験コース",p:30000,a:"小3〜小6"}],locs:[{n:"溝の口校",ad:"川崎市高津区溝口1丁目",st:"溝の口駅より徒歩2分"}],revs:[{g:"男の子",a:"9歳〜",l:"溝の口校",t:"レベルの高い授業でしっかり力がつきます。"}],color:"#5C6BC0",emoji:"🎓"},
  ],
};

const CATS = [
  {name:"ダンス",count:45,icon:"💃"},{name:"サッカー",count:33,icon:"⚽"},
  {name:"英語・英会話",count:29,icon:"🌍"},{name:"ピアノ",count:23,icon:"🎹"},
  {name:"スイミング",count:16,icon:"🏊"},{name:"バレエ",count:10,icon:"🩰"},
  {name:"空手",count:6,icon:"🥋"},{name:"K-POP",count:12,icon:"💜"},
  {name:"リトミック",count:12,icon:"🎵"},{name:"幼児教室",count:12,icon:"🧒"},
  {name:"学習塾",count:45,icon:"📝"},
];

const INFO = {
  "ダンス":{fee:"5,000〜10,000円",age:"3歳〜",skills:"リズム感・柔軟性・集中力・協調性",desc:"中学校で必修化されたダンス。川崎市高津区ではリディアダンスアカデミーが2校を展開し、初心者クラスが充実しています。"},
  "サッカー":{fee:"3,000〜8,000円",age:"3歳〜",skills:"体力・瞬発力・協調性・判断力",desc:"チームプレーで協調性が身につく人気スポーツ。川崎市高津区にも多数のスクールがあります。"},
...
const AREAS=[{n:"溝の口",c:25},{n:"高津",c:15},{n:"二子新地",c:10},{n:"梶が谷",c:8}];
...
return (<article style={{background:"linear-gradient(135deg,#fff,#FFF8F7)",borderRadius:20,boxShadow:`0 8px 40px ${s.color}18`,border:`2px solid ${s.color}22`,position:"relative",animation:"fi .6s ease"}}>
  ...
  <Acc title={`📍 川崎市高津区の教室（${s.locs.length}校）`} color={s.color} open={loc} toggle={()=>setLoc(!loc)}>{s.locs.map((l,i)=><LocRow key={i} l={l} color={s.color} last={i===s.locs.length-1}/>)}</Acc>
...
export default function App(){
  ...
  useEffect(()=>{
    ...
    document.title=`川崎市高津区の${cat}スクールおすすめ一覧【2026年】| コドモならいごと`;
    return()=>sc.remove();
  },[cat]);
  ...
  return (<div style={{fontFamily:"'Noto Sans JP','Hiragino Sans',sans-serif",background:"#f5f6fa",minHeight:"100vh"}}>
    ...
    <header style={{background:"linear-gradient(135deg,#4527A0,#311B92)",color:"#fff",position:"sticky",top:0,zIndex:100,boxShadow:"0 4px 20px rgba(0,0,0,.15)"}}><div style={{maxWidth:1100,margin:"0 auto",padding:"12px 20px",display:"flex",alignItems:"center",justifyContent:"space-between"}}><a href="/" style={{display:"flex",alignItems:"center",gap:10,textDecoration:"none",color:"inherit"}}><span style={{fontSize:26}}>🧒</span><div><div style={{fontSize:18,fontWeight:900}}>コドモならいごと</div><div style={{fontSize:10,opacity:.8}}>子供の習い事を口コミで比較</div></div></a><span style={{fontSize:12,opacity:.9}}>📍 川崎市高津区</span></div></header>

    <nav aria-label="パンくず" style={{maxWidth:1100,margin:"0 auto",padding:"12px 20px"}}><div style={{fontSize:12,color:"#888"}}><a href="#" style={{color:"#4527A0",textDecoration:"none"}}>トップ</a> › <a href="#" style={{color:"#4527A0",textDecoration:"none"}}>{cat}</a> › <a href="#" style={{color:"#4527A0",textDecoration:"none"}}>神奈川県</a> › <span style={{color:"#666"}}>川崎市高津区</span></div></nav>

    <div style={{maxWidth:1100,margin:"0 auto",padding:"0 20px"}}><div style={{background:"linear-gradient(135deg,#EDE7F6,#D1C4E9,#E8EAF6)",borderRadius:20,padding:"28px 24px",position:"relative",overflow:"hidden"}}>
      <div style={{position:"absolute",right:-10,top:-10,fontSize:100,opacity:.1,transform:"rotate(-15deg)"}}>{catData?.icon}</div>
      <h1 style={{fontSize:22,fontWeight:900,color:"#1a1a2e",lineHeight:1.4,margin:0}}>川崎市高津区の<span style={{color:"#4527A0"}}>{cat}スクール</span><br/>おすすめ一覧<span style={{fontSize:13,fontWeight:400,color:"#888"}}>【2026年最新】</span></h1>
      <p style={{fontSize:13,color:"#666",marginTop:8,lineHeight:1.6}}>溝の口を中心に商業と住宅が融合する高津区。交通アクセスが良く通いやすい教室が多数。</p>
      <div style={{display:"flex",gap:12,marginTop:14,flexWrap:"wrap"}}>
        <div style={{background:"#fff",borderRadius:12,padding:"8px 14px",boxShadow:"0 2px 8px rgba(0,0,0,.06)"}}><div style={{fontSize:10,color:"#888"}}>掲載数</div><div style={{fontSize:20,fontWeight:900,color:"#4527A0"}}>{catData?.count}<span style={{fontSize:11,fontWeight:400}}>件</span></div></div>
      ...
      <div style={{marginTop:16}}><input type="text" placeholder="🔍 スクール名で検索..." value={search} onChange={e=>setSearch(e.target.value)} style={{width:"100%",padding:"11px 16px",borderRadius:12,border:"2px solid #e0e0e0",fontSize:14,outline:"none",background:"#fff"}} onFocus={e=>e.target.style.borderColor="#4527A0"} onBlur={e=>e.target.style.borderColor="#e0e0e0"}/></div>
    </div></div>
    ...
    <nav style={{maxWidth:1100,margin:"0 auto",padding:"18px 20px 0"}}><h2 style={{fontSize:14,fontWeight:700,color:"#333",marginBottom:10}}>🏷️ 習い事の種類</h2>
      <div style={{display:"flex",gap:7,overflowX:"auto",paddingBottom:8}}>
        {CATS.map(c=><button key={c.name} onClick={()=>{setCat(c.name);setSearch("");}} style={{display:"inline-flex",alignItems:"center",gap:5,padding:"7px 14px",borderRadius:24,whiteSpace:"nowrap",cursor:"pointer",border:cat===c.name?"2px solid #4527A0":"2px solid #e8e8e8",background:cat===c.name?"linear-gradient(135deg,#4527A0,#311B92)":"#fff",color:cat===c.name?"#fff":"#555",fontWeight:cat===c.name?700:500,fontSize:13,transition:"all .2s",boxShadow:cat===c.name?`0 4px 12px #4527A044`:"none"}}><span>{c.icon}</span><span>{c.name}</span><span style={{fontSize:11,opacity:.8}}>({c.count})</span></button>)}
      </div>
    </nav>
    ...
    <div style={{maxWidth:1100,margin:"0 auto",padding:"14px 20px 0"}}><button onClick={()=>setShowArea(!showArea)} style={{display:"flex",alignItems:"center",gap:8,padding:"9px 16px",borderRadius:12,border:"2px solid #e0e0e0",background:"#fff",cursor:"pointer",fontSize:13,fontWeight:600,color:"#444"}}>📍 エリア絞り込み{area?`：${area}`:""}<span style={{transform:showArea?"rotate(180deg)":"",transition:".2s",fontSize:12}}>▼</span></button>
      {showArea&&<div style={{marginTop:8,display:"flex",flexWrap:"wrap",gap:6,background:"#fff",padding:14,borderRadius:12,boxShadow:"0 4px 16px rgba(0,0,0,.08)",animation:"fi .2s ease"}}><button onClick={()=>{setArea(null);setShowArea(false);}} style={{padding:"5px 12px",borderRadius:20,border:!area?"2px solid #4527A0":"1px solid #e0e0e0",background:!area?"#EDE7F6":"#fff",color:!area?"#4527A0":"#666",fontSize:12,fontWeight:600,cursor:"pointer"}}>全エリア</button>{AREAS.map(a2=><button key={a2.n} onClick={()=>{setArea(a2.n);setShowArea(false);}} style={{padding:"5px 12px",borderRadius:20,border:area===a2.n?"2px solid #4527A0":"1px solid #e0e0e0",background:area===a2.n?"#EDE7F6":"#fff",color:area===a2.n?"#4527A0":"#666",fontSize:12,fontWeight:500,cursor:"pointer"}}>{a2.n}({a2.c})</button>)}</div>}
    </div>

    <div style={{maxWidth:1100,margin:"0 auto",padding:"18px 20px 0"}}><div style={{fontSize:14,color:"#666"}}><span style={{fontWeight:800,fontSize:20,color:"#4527A0"}}>{regular.length+(featured?1:0)}</span> 件のスクール</div></div>
    ...
    <section style={{background:"#f5f6fa",padding:"36px 20px"}}><div style={{maxWidth:1100,margin:"0 auto"}}>
      ...
      <FAQ q={`川崎市高津区で人気の${cat}スクールは？`} a={`川崎市高津区で人気の${cat}スクールは${schools.slice(0,3).map(s=>`${s.name}（${s.rating?s.rating+'点':'-'}）`).join('、')}などがあります。`}/>
      <FAQ q={`${cat}スクールの月謝はいくら？`} a={`川崎市高津区の${cat}スクールの月謝相場は${info.fee}です。`}/>
      <FAQ q={`子どもに${cat}を習わせるメリットは？`} a={`${info.skills}などが身につきます。${info.desc}`}/>
      {cat==="ダンス"&&<FAQ q="リディアダンスアカデミーの川崎市高津区の教室は？" a="川崎市高津区には高津校、溝口校の2校があります。初回体験無料です。"/>}
    </div></section>
