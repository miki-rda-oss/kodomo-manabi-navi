...
const PREF_SLUG = 'kumamoto';
const PREF_NAME = '熊本県';
const PREF_NAME_SHORT = '熊本';
const PREF_CITY = '熊本市';
...
const breadcrumbSchema = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"熊本県の習い事","item":"https://www.kodomo-navi.com/kumamoto"}]};
const faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"熊本県内の子供ダンス教室の月謝相場は？","acceptedAnswer":{"@type":"Answer","text":"熊本県の子供ダンス教室は月5,000円〜8,000円程度が相場です。"}},{"@type":"Question","name":"熊本県で3歳から通えるダンス教室はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。熊本県内のダンス教室の多くが3歳から入会できるリトルクラスを設けています。"}},{"@type":"Question","name":"熊本県の有名なダンス教室はどこですか？","acceptedAnswer":{"@type":"Answer","text":"リディアダンスアカデミーをはじめ、熊本県には人気のダンス教室が多数あります。口コミ評価も高く、体験レッスンも随時受付中です。"}}]};
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/kumamoto', '⚽', 'サッカー'],
              ['/piano/kumamoto', '🎹', 'ピアノ'],
              ['/swimming/kumamoto', '🏊', 'スイミング'],
              ['/english/kumamoto', '🌍', '英語'],
              ['/ballet/kumamoto', '🩰', 'バレエ'],
              ['/gymnastics/kumamoto', '🤸', '体操'],
              ['/basketball/kumamoto', '🏀', 'バスケット'],
              ['/preschool/kumamoto', '🧒', '幼児教室'],
              ['/soroban/kumamoto', '🧮', 'そろばん'],
              ['/programming/kumamoto', '💻', 'プログラミング'],
              ['/rhythmics/kumamoto', '🎵', 'リトミック'],
              ['/music/kumamoto', '🎸', '音楽'],
              ['/karate/kumamoto', '🥋', '空手'],
