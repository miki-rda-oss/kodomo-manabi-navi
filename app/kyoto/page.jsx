...
export const metadata = {
  title: '京都府の子供向けダンス教室・習い事一覧｜コドモならいごと',
...
const faqs = [
  { q: '京都府内の子供ダンス教室の月謝相場は？', a: '京都府の子供ダンス教室は月5,000円〜8,000円程度が相場です。京都市内は地下鉄・バス沿線に教室が多く通いやすい立地が多いです。' },
  { q: '京都市でおすすめの子供ダンス教室は？', a: '京都市はリディアダンスアカデミーが展開しています。市内は四条・烏丸・北区・伏見区など各エリアに教室が点在しています。' },
  { q: '京都でダンス以外の習い事情報はありますか？', a: 'はい。スイミング・英語・ピアノ・バレエなど伝統的な習い事から最新のプログラミングまで幅広く掲載しています。' },
  { q: '京都市内の習い事、おすすめの選び方は？', a: '京都市内は交通機関が発達していますが、エリアによって混雑状況が異なります。最寄り駅・バス停からの距離と曜日・時間帯の混雑を確認してから選ぶのがおすすめです。' },
];

const blogs = [
  { href: '/blog/kyoto-kids-dance-school-ranking', text: '京都で子供のダンス教室おすすめランキング【2026年版】' },
    ...
    <div style={{ fontFamily: "'Noto Sans JP','Hiragino Sans',sans-serif", background: "#f4f7fc", minHeight: "100vh" }}>
      ...
      <header style={{ background: "#fff", borderBottom: "1px solid #e8edf4", boxShadow: "0 2px 8px rgba(0,0,0,.05)", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", gap: 10, height: 56 }}>
          ...
          <span style={{ fontSize: 13, color: "#888", fontWeight: 600 }}>京都府</span>
        </div>
      </header>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A, #2a4070)", padding: "44px 24px 40px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 900, color: "#fff", marginBottom: 12 }}>京都府の子供向け<br />ダンス教室・習い事</h1>
          <p style={{ fontSize: 14, color: "rgba(255,255,255,.85)", lineHeight: 1.9 }}>
            千年の都・京都でお子さまの習い事を探そう<br />
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 18, paddingBottom: 12, borderBottom: "2px solid #FF8A0020" }}>📍 京都府のエリアを選ぶ</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12 }}>
            {areas.map((area) => (
              <Link key={area.slug} href={`/kyoto/${area.slug}`} style={{ display: "block", background: "#fff", border: "1.5px solid #e8edf4", borderRadius: 12, padding: "16px 18px", textDecoration: "none", color: "#1B2A4A", fontWeight: 700, fontSize: 15, boxShadow: "0 2px 8px rgba(0,0,0,.04)" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 18, paddingBottom: 12, borderBottom: "2px solid #FF8A0020" }}>❓ よくある質問（京都の習い事）</h2>
        ...
        <section style={{ maxWidth: 900, margin: "0 auto 40px", padding: "0 0px" }}>
          <div style={{ background: "linear-gradient(135deg, #fff7ee, #fff0f5)", borderRadius: 16, padding: "24px 20px", border: "1.5px solid #FFD9A0" }}>
            <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 12 }}>
              🥇 京都の習い事トレンド2026：ダンスが1位
            </h2>
            <p style={{ fontSize: 14, lineHeight: 1.9, color: "#444", marginBottom: 16 }}>
              京都でもダンス習い事の人気が高まる。K-POPブームと中学校ダンス必修化の影響で、京都でも子供のダンス習い事への需要が急増しています。
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/kyoto', '⚽', 'サッカー'],
              ['/piano/kyoto', '🎹', 'ピアノ'],
              ['/swimming/kyoto', '🏊', 'スイミング'],
              ['/english/kyoto', '🌍', '英語'],
              ['/ballet/kyoto', '🩰', 'バレエ'],
              ['/gymnastics/kyoto', '🤸', '体操'],
              ['/basketball/kyoto', '🏀', 'バスケット'],
              ['/preschool/kyoto', '🧒', '幼児教室'],
              ['/soroban/kyoto', '🧮', 'そろばん'],
              ['/programming/kyoto', '💻', 'プログラミング'],
              ['/rhythmics/kyoto', '🎵', 'リトミック'],
              ['/music/kyoto', '🎸', '音楽'],
              ['/karate/kyoto', '🥋', '空手'],
