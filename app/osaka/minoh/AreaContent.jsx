...
const S = {
  "ダンス": [
    { id:"d0", name:"リディアダンスアカデミー", rating:4.8, rc:312, age:"3歳〜15歳", featured:true, trialUrl:"https://liff.line.me/2001597193-pyJx1bKd/landing?follow=%40084nrdoa&lp=L1pmYU&liff_id=2001597193-pyJx1bKd", url:"https://re-dia.jp/",
      ...
      revs:[{g:"女の子",a:"3歳〜",l:"箕面船場阪大前校",t:"娘が3歳から通っています。ダンスだけでなく人としても大きく成長させていただいています。"},{g:"女の子",a:"7歳〜",l:"箕面船場阪大前校",t:"先生がとても丁寧で発表会も充実しています。毎週楽しみに通っています。"},{g:"女の子",a:"7歳〜",l:"箕面森町校",t:"DANCEを始めてから人前で自分の思いを伝えられるようになりました。"},{g:"女の子",a:"5歳〜",l:"桜井校",t:"先生が子どもの個性を大切にしてくれて、毎回楽しくレッスンに通っています。"}],
      color:"#E53935", emoji:"🏆"},
    { id:"d6", name:"ダンススタジオDLB 箕面校", rating:4.5, rc:42, age:"幼稚園〜大人", url:"https://www.dancestudiodlb-minoh.com/",
      desc:"北摂地域会員数No.1・15年以上の歴史を誇るダンススクール。K-POPとストリートダンス専門。チケット制でフレキシブルに通えるのが特徴。入退館システム導入で安心。",
      tags:["北摂会員数No.1","15年以上の歴史","K-POP専門","初心者歓迎","チケット制"],
      genres:["K-POP","ヒップホップ","ストリートダンス"],
      courses:[{n:"キッズクラス",p:null,a:"幼稚園〜小学生"},{n:"ジュニアクラス",p:null,a:"中高生"},{n:"体験レッスン",p:1100,a:"全年齢"}],
      locs:[{n:"箕面校",ad:"箕面市桜1丁目1-1 ムーブスポーツパーク内 ジョイタウン2F",st:"阪急牧落駅より徒歩4分"}],
      revs:[{g:"女の子",a:"9歳〜",l:"箕面校",t:"K-POPが大好きな娘が楽しんで通っています。先生がとても熱心です。"}],
      color:"#AB47BC", emoji:"💜"},
    { id:"d7", name:"エイベックス・ダンスマスター箕面萱野校", rating:4.4, rc:28, age:"年中〜高校生", url:"https://dancemaster.avex.jp/studios/station/%E7%AE%95%E9%9D%A2%E8%90%B1%E9%87%8E",
      desc:"エイベックス直営のキッズダンススクール。HIPHOPを中心に初心者が楽しめる環境を重視。みのおキューズモール内の好立地で保護者も買い物しながら待機可能。",
      tags:["エイベックス直営","初心者歓迎","体験レッスン随時","キューズモール内"],
      genres:["ヒップホップ","キッズダンス"],
      courses:[{n:"リトルキッズ",p:null,a:"年中〜年長"},{n:"キッズ",p:null,a:"小学生"},{n:"ティーン",p:null,a:"中高生"}],
      locs:[{n:"箕面萱野校",ad:"箕面市坊島4-1-24 箕面マーケットパークヴィソラWest2",st:"箕面萱野駅より徒歩5分"}],
      revs:[{g:"女の子",a:"6歳〜",l:"箕面萱野校",t:"エイベックス直営なので安心感があります。先生がとても優しいです。"}],
      color:"#1B2A4A", emoji:"⭐"},
    { id:"d8", name:"箕面レディースクリニック ダンス教室", rating:4.3, rc:15, age:"4歳〜大人", url:"https://www.mino-lc.net/class/dance/",
      desc:"「初心者大歓迎」のアットホームなダンス教室。HIP HOP・LOCK・K-POP・BREAKの4スタイルを提供。初回無料体験・入会金無料キャンペーン実施中。",
      tags:["初心者大歓迎","初回無料体験","入会金無料","4スタイル対応"],
      genres:["ヒップホップ","ロック","K-POP","ブレイクダンス"],
      courses:[{n:"通常クラス",p:4000,a:"4歳〜"},{n:"上級クラス",p:5500,a:"小学生〜"}],
      locs:[{n:"箕面レディースクリニック分院",ad:"箕面市牧落3-3-33 分院4F多目的ホール",st:"牧落駅より徒歩5分"}],
      revs:[{g:"女の子",a:"5歳〜",l:"箕面レディースクリニック",t:"月謝が手頃でアットホームな雰囲気が気に入っています。"}],
      color:"#26A69A", emoji:"🎵"},
    { id:"d9", name:"Kassaa Kids Dance", rating:4.5, rc:8, age:"年中〜小学生", url:"https://kassaa-kids.amebaownd.com/",
      desc:"彩都エリア発の子ども専門ダンス教室。講師Kassaaは指導歴10年。ヨガ・ダンス・ボディワークを融合した独自のプログラムで、シャイな子も楽しめる環境づくりを重視。",
      tags:["指導歴10年","彩都エリア","シャイさんOK","少人数制","発表会あり"],
      genres:["ダンス","ボディワーク"],
      courses:[{n:"キッズクラス",p:null,a:"年中〜小学生"}],
      locs:[{n:"彩都クラス",ad:"箕面市彩都エリア",st:"詳細はお問い合わせください"}],
      revs:[{g:"女の子",a:"5歳〜",l:"彩都クラス",t:"恥ずかしがり屋の娘でも楽しく参加できています。先生の指導が丁寧です。"}],
      color:"#FF7043", emoji:"🌟"},
    { id:"d10", name:"箕面インターナショナルキッズアートスクール", rating:4.4, rc:12, age:"小学生〜", url:"https://www.mino-ikas.com/page-contemporary.html",
      desc:"コンテンポラリーダンスを専門とするユニークな教室。音楽のジャンルを問わず自由に踊るスタイルで創造性・独創性を育む。発表会・コンクール参加の機会も充実。",
      tags:["コンテンポラリー専門","創造性重視","発表会あり","コンクール参加"],
      genres:["コンテンポラリーダンス"],
      courses:[{n:"コンテンポラリークラス",p:null,a:"小学生〜"}],
      locs:[{n:"箕面スタジオ",ad:"箕面市森町南2-1-24",st:"お問い合わせください"}],
      revs:[{g:"女の子",a:"8歳〜",l:"箕面スタジオ",t:"普通のダンス教室と違って創作ダンスが楽しいです。個性を伸ばしてもらえます。"}],
      color:"#5C6BC0", emoji:"🎨"},
    { id:"d11", name:"UNO DANCE STUDIO", rating:4.3, rc:10, age:"子ども〜大人", url:"https://uno-dance-studio.jimdofree.com/",
      desc:"箕面エリアのダンスストゥジオ。キッズから大人まで幅広く対応したダンス教室。",
      tags:["キッズ歓迎","体験レッスンあり"],
      genres:["ストリートダンス","ヒップホップ"],
      courses:[{n:"キッズクラス",p:null,a:"子ども"},{n:"一般クラス",p:null,a:"大人"}],
      locs:[{n:"箕面スタジオ",ad:"箕面市内",st:"お問い合わせください"}],
      revs:[{g:"女の子",a:"7歳〜",l:"箕面スタジオ",t:"楽しく通わせてもらっています。"}],
      color:"#78909C", emoji:"💃"},
    { id:"d5", name:"BEAT ART DANCE STUDIO 箕面船場阪大前スタジオ", rating:4.6, rc:38, age:"年中〜大人", url:"https://beat-art-dance.com/studio/minoh-semba/",
      desc:"66坪・北摂最大級の4スタジオ併設ダンスクール。週45レッスン以上を開講。HIPHOP・K-POP・Girls HIPHOP・ブレイクなど多彩なジャンルに対応。初心者から経験者まで歓迎。",
      tags:["北摂最大級","週45レッスン+","多ジャンル対応","初心者歓迎","4スタジオ"],
      genres:["ヒップホップ","K-POP","Girls HIPHOP","ブレイク","Jazz HIPHOP","Soul & Waack"],
      courses:[{n:"キッズクラス",p:null,a:"年中〜小学生"},{n:"ジュニアクラス",p:null,a:"中高生"},{n:"一般クラス",p:null,a:"大人"}],
      locs:[{n:"箕面船場阪大前スタジオ",ad:"箕面市船場東1-10-9 2F",st:"箕面船場阪大前駅より徒歩4分"}],
      revs:[{g:"女の子",a:"8歳〜",l:"箕面船場阪大前スタジオ",t:"スタジオが広くて設備が充実。先生も上手でレッスンが楽しいです。"}],
      color:"#FF6B35", emoji:"💃"},
  ],
  "サッカー": [
    { id:"s1",name:"ガンバ大阪スクール",rating:4.4,rc:65,age:"年少〜小6",desc:"Jリーグ・ガンバ大阪が運営する公式スクール。プロの指導メソッドで基礎から応用まで楽しく学べます。",courses:[{n:"キッズ（年少〜年長）",p:4400,a:"年少〜年長"},{n:"U-9",p:6600,a:"小1〜小3"},{n:"U-12",p:7700,a:"小4〜小6"}],locs:[{n:"万博フットサルクラブ校",ad:"吹田市千里万博公園3-3",st:"万博記念公園駅より徒歩10分"}],revs:[{g:"男の子",a:"5歳〜",l:"万博フットサルクラブ校",t:"ガンバのユニフォームで練習できて子どもが大喜び。基礎がしっかり身につきました。"}],color:"#1565C0",emoji:"⚽"},
    { id:"s2",name:"リベルタサッカースクール",rating:4.1,rc:12,age:"3歳〜12歳",desc:"「認める・褒める・励ます」の指導方針。元プロ選手コーチが技術とメンタルを育成。",courses:[{n:"通常コース",p:7103,a:"3歳〜12歳"}],locs:[{n:"箕面校",ad:"箕面市新稲2丁目",st:"箕面駅より徒歩8分"}],revs:[{g:"男の子",a:"5歳〜",l:"箕面校",t:"上手な子に刺激を受けて頑張るようになりました。"}],color:"#4CAF50",emoji:"🏃"},
    { id:"s3",name:"箕面FC",rating:4.3,rc:18,age:"年長〜小6",desc:"箕面市で40年以上の歴史を持つ地域密着型サッカークラブ。試合経験も豊富で仲間づくりにも最適。",courses:[{n:"通常コース",p:3000,a:"年長〜小6"}],locs:[{n:"箕面市立第一中学校グラウンド",ad:"箕面市箕面5丁目",st:"箕面駅より徒歩8分"}],revs:[{g:"男の子",a:"6歳〜",l:"箕面市立第一中学校グラウンド",t:"地元の友達がたくさんできて、毎週楽しみに通っています。"}],color:"#FF9800",emoji:"⚡"},
  ],
  "英語・英会話": [
    { id:"e1",name:"ECC KIDS",rating:4.4,rc:180,age:"1歳半〜",desc:"All Englishの環境で自然に英語が身につく。外国人講師とバイリンガル講師のペアティーチング。",courses:[{n:"ミニキッズ",p:9900,a:"1歳半〜3歳"},{n:"キッズイングリッシュワールド",p:11000,a:"3歳〜6歳"},{n:"小学生コース",p:11000,a:"6歳〜12歳"}],locs:[{n:"千里中央校",ad:"豊中市新千里東町1丁目4-2",st:"千里中央駅より徒歩3分"}],revs:[{g:"女の子",a:"4歳〜",l:"千里中央校",t:"外国人の先生と楽しく英語を話せるようになり、抵抗がなくなりました。"}],color:"#FF6F00",emoji:"🌍"},
    { id:"e2",name:"シェーン英会話",rating:4.3,rc:95,age:"2歳〜",desc:"ネイティブ講師による少人数制。英国式メソッドで4技能をバランスよく習得。",courses:[{n:"2歳〜年少",p:7700,a:"2歳〜4歳"},{n:"年中・年長",p:11000,a:"4歳〜6歳"},{n:"小学生",p:11000,a:"6歳〜12歳"}],locs:[{n:"千里中央校",ad:"豊中市新千里東町1丁目",st:"千里中央駅より徒歩2分"}],revs:[{g:"男の子",a:"5歳〜",l:"千里中央校",t:"ネイティブの先生の発音を聞いて育つので発音がきれいです。"}],color:"#2196F3",emoji:"📚"},
  ],
  "ピアノ": [
    { id:"p1",name:"ヤマハ音楽教室",rating:4.5,rc:210,age:"1歳〜",desc:"「きく→うたう→ひく→よむ→つくる」のステップで総合的な音楽力を育てる老舗教室。",courses:[{n:"ぷっぷるコース",p:5500,a:"1歳〜3歳"},{n:"幼児科",p:7700,a:"4歳〜5歳"},{n:"ジュニアスクール ピアノ",p:8800,a:"小学生"}],locs:[{n:"箕面センター",ad:"箕面市箕面6丁目",st:"箕面駅より徒歩5分"}],revs:[{g:"女の子",a:"4歳〜",l:"箕面センター",t:"グループレッスンで友達と楽しく学べています。音感がとても良くなりました。"}],color:"#FF5722",emoji:"🎹"},
    { id:"p2",name:"カワイ音楽教室",rating:4.3,rc:155,age:"3歳〜",desc:"「音楽で一人ひとりの個性を導き出す」教育理念。個人レッスン中心の丁寧な指導。",courses:[{n:"ピアノコース",p:8250,a:"4歳〜"},{n:"3歳ソルフェージュ",p:6600,a:"3歳"}],locs:[{n:"箕面教室",ad:"箕面市西小路3丁目",st:"牧落駅より徒歩5分"}],revs:[{g:"女の子",a:"5歳〜",l:"箕面教室",t:"個人レッスンでしっかり教えていただけるので上達が早いです。"}],color:"#E91E63",emoji:"🎶"},
  ],
  "スイミング": [
    ...
    { id:"sw2",name:"ルネサンス スイミング",rating:4.2,rc:68,age:"6ヶ月〜",desc:"楽しく安全に水に親しめるプログラム。コーチの質の高さに定評あり。",courses:[{n:"ベビー",p:7150,a:"6ヶ月〜3歳"},{n:"ジュニア",p:8800,a:"3歳〜"}],locs:[{n:"箕面校",ad:"箕面市萱野5丁目",st:"箕面萱野駅より徒歩5分"}],revs:[{g:"女の子",a:"3歳〜",l:"箕面校",t:"先生が優しくて子どもが楽しそうに通っています。"}],color:"#26C6DA",emoji:"🌊"},
  ],
  "バレエ": [
    ...
    { id:"b2",name:"みのおバレエスタジオ",rating:4.4,rc:22,age:"3歳〜",desc:"箕面の地域密着型バレエ教室。アットホームな雰囲気で初心者でも安心の少人数制レッスン。",courses:[{n:"プレバレエ",p:6600,a:"3歳〜5歳"},{n:"ジュニアクラス",p:7700,a:"小学生"}],locs:[{n:"牧落スタジオ",ad:"箕面市牧落3丁目",st:"牧落駅より徒歩3分"}],revs:[{g:"女の子",a:"5歳〜",l:"牧落スタジオ",t:"先生が優しくて楽しく通えています。柔軟性がかなり良くなりました。"}],color:"#9C27B0",emoji:"🌸"},
  ],
  "空手": [
    { id:"k1",name:"極真会館 箕面道場",rating:4.5,rc:35,age:"4歳〜",desc:"世界最大の空手団体の箕面道場。礼儀作法と強い心を育てる伝統的な空手教育。",courses:[{n:"少年部",p:7700,a:"4歳〜12歳"},{n:"中等部",p:8800,a:"12歳〜15歳"}],locs:[{n:"箕面道場",ad:"箕面市西小路3丁目",st:"牧落駅より徒歩5分"}],revs:[{g:"男の子",a:"5歳〜",l:"箕面道場",t:"礼儀正しくなり何事にも最後まで諦めない粘り強さが身につきました。"}],color:"#F44336",emoji:"🥋"},
  ],
  "K-POP": [
    { id:"kp0",name:"リディアダンスアカデミー",rating:4.8,rc:45,age:"3歳〜15歳",featured:true,url:"https://re-dia.jp/",
      ...
      revs:[{g:"女の子",a:"8歳〜",l:"箕面船場阪大前校",t:"K-POPの曲で踊れるのがとても楽しい！先生も優しくて毎週通うのが楽しみです。"},{g:"女の子",a:"10歳〜",l:"箕面森町校",t:"推しの振付を本格的に学べて最高！ダンスの基礎もしっかり身につきました。"}],
      color:"#E53935",emoji:"🏆"},
    { id:"kp1",name:"NOAダンスアカデミー",rating:4.5,rc:48,age:"4歳〜",desc:"K-POPダンスに特化したクラスが充実。最新の振付をいち早くレッスンに導入。",courses:[{n:"キッズK-POP",p:8800,a:"4歳〜8歳"},{n:"ジュニアK-POP",p:9900,a:"8歳〜15歳"}],locs:[{n:"千里中央校",ad:"豊中市新千里東町1丁目",st:"千里中央駅より徒歩5分"}],revs:[{g:"女の子",a:"8歳〜",l:"千里中央校",t:"大好きなK-POPの曲で踊れるのが嬉しくて毎週楽しみにしています。"}],color:"#AB47BC",emoji:"💜"},
  ],
  "リトミック": [
    { id:"rt1",name:"カワイ リトミック教室",rating:4.4,rc:88,age:"1歳〜",desc:"音楽の力で子どもの感性と表現力を育む。ピアノの生演奏に合わせて楽しく身体を動かします。",courses:[{n:"1歳クラス",p:5500,a:"1歳"},{n:"2歳クラス",p:5500,a:"2歳"},{n:"3歳ソルフェージュ",p:6600,a:"3歳"}],locs:[{n:"箕面教室",ad:"箕面市西小路3丁目",st:"牧落駅より徒歩5分"}],revs:[{g:"女の子",a:"1歳〜",l:"箕面教室",t:"音楽に合わせて体を動かすのがとても楽しそうです。リズム感がついてきました。"}],color:"#FF7043",emoji:"🎵"},
    { id:"rt2",name:"ヤマハ音楽教室 ドレミらんど",rating:4.5,rc:120,age:"1歳〜3歳",desc:"親子で楽しめる音楽体験。音楽の楽しさを感覚的に吸収します。",courses:[{n:"らっきークラス",p:5500,a:"1歳〜2歳"},{n:"ぷっぷるクラス",p:5500,a:"2歳〜3歳"}],locs:[{n:"箕面センター",ad:"箕面市箕面6丁目",st:"箕面駅より徒歩5分"}],revs:[{g:"男の子",a:"1歳〜",l:"箕面センター",t:"親子で一緒に楽しめるのが嬉しい。音楽への興味がぐんぐん広がっています。"}],color:"#FFA726",emoji:"🎶"},
  ],
  "幼児教室": [
    { id:"yj1",name:"ベビーパーク",rating:4.4,rc:95,age:"0歳〜3歳",desc:"「叱らない育児」で知られる親子教室。IQ140以上を目指す独自の知育プログラム。",courses:[{n:"Aクラス(0歳2ヶ月〜)",p:15400,a:"0歳〜"},{n:"Bクラス",p:15400,a:"0歳9ヶ月〜"},{n:"Cクラス",p:15400,a:"1歳4ヶ月〜"}],locs:[{n:"千里中央教室",ad:"豊中市新千里東町1丁目",st:"千里中央駅より徒歩3分"}],revs:[{g:"男の子",a:"0歳〜",l:"千里中央教室",t:"親子で楽しく学べています。言葉の発達がとても早くなりました。"}],color:"#FF8A65",emoji:"🧒"},
    { id:"yj2",name:"七田式教室",rating:4.3,rc:78,age:"0歳〜6歳",desc:"右脳教育のパイオニア。フラッシュカードや暗唱で子どもの無限の可能性を引き出します。",courses:[{n:"幼児コース",p:15400,a:"0歳〜6歳"},{n:"小学生コース",p:15400,a:"6歳〜12歳"}],locs:[{n:"箕面教室",ad:"箕面市箕面6丁目",st:"箕面駅より徒歩3分"}],revs:[{g:"女の子",a:"2歳〜",l:"箕面教室",t:"記憶力がすごく伸びて、絵本をすらすら暗唱するようになりました。"}],color:"#42A5F5",emoji:"📖"},
  ],
  "学習塾": [
    { id:"gk1",name:"公文式教室",rating:4.3,rc:250,age:"3歳〜",desc:"自学自習で「ちょうどの学習」。一人ひとりのペースに合わせたプリント学習で基礎学力を鍛えます。",courses:[{n:"算数・数学",p:7700,a:"3歳〜"},{n:"国語",p:7700,a:"3歳〜"},{n:"英語",p:8800,a:"3歳〜"}],locs:[{n:"箕面駅前教室",ad:"箕面市箕面6丁目",st:"箕面駅より徒歩2分"},{n:"牧落教室",ad:"箕面市牧落3丁目",st:"牧落駅より徒歩3分"}],revs:[{g:"男の子",a:"5歳〜",l:"箕面駅前教室",t:"自分のペースで進められるので無理なく学力がつきました。"}],color:"#1E88E5",emoji:"📝"},
    { id:"gk2",name:"学研教室",rating:4.2,rc:180,age:"3歳〜",desc:"「自分で考える力」を育てる教室。算数・国語の基礎から応用まで少人数制で指導。",courses:[{n:"算数・国語コース",p:8800,a:"年少〜小学生"},{n:"算数・国語・英語コース",p:13200,a:"小学生"}],locs:[{n:"箕面教室",ad:"箕面市西小路4丁目",st:"牧落駅より徒歩5分"}],revs:[{g:"女の子",a:"6歳〜",l:"箕面教室",t:"算数が苦手でしたが通い始めてからテストの点数が上がりました。"}],color:"#43A047",emoji:"✏️"},
    { id:"gk3",name:"馬渕教室",rating:4.5,rc:90,age:"小1〜",desc:"関西圏で圧倒的な合格実績を誇る進学塾。北摂エリアの難関中学・高校受験に強い。",courses:[{n:"小学生コース",p:16500,a:"小1〜小6"},{n:"中学受験コース",p:33000,a:"小3〜小6"}],locs:[{n:"箕面校",ad:"箕面市箕面6丁目3-1",st:"箕面駅より徒歩2分"}],revs:[{g:"男の子",a:"9歳〜",l:"箕面校",t:"レベルの高い授業でしっかり力がつきます。中学受験に向けて頑張っています。"}],color:"#5C6BC0",emoji:"🎓"},
  ],
};

const CATS = [
  {name:"ダンス",count:45,icon:"💃"},
  {name:"サッカー",count:32,icon:"⚽"},
  {name:"英語・英会話",count:28,icon:"🌍"},
  {name:"ピアノ",count:35,icon:"🎹"},
  {name:"スイミング",count:12,icon:"🏊"},
  {name:"バレエ",count:18,icon:"🩰"},
  {name:"空手",count:15,icon:"🥋"},
  {name:"K-POP",count:10,icon:"💜"},
  {name:"リトミック",count:14,icon:"🎵"},
  {name:"幼児教室",count:16,icon:"🧒"},
  {name:"学習塾",count:55,icon:"📝"},
];

const INFO = {
  "ダンス":{fee:"5,000〜10,000円",age:"3歳〜",skills:"リズム感・柔軟性・集中力・協調性",desc:"中学校で必修化されたダンス。箕面エリアではリディアダンスアカデミーが6校を展開し、初心者クラスが充実。発表会は大きな会場で開催され、お子様の成長を実感できます。"},
  "サッカー":{fee:"3,000〜8,000円",age:"3歳〜",skills:"体力・瞬発力・協調性・判断力",desc:"チームプレーで協調性が身につく人気スポーツ。箕面エリアではガンバ大阪スクールや地域密着型の箕面FCなどが活動しています。"},
  "英語・英会話":{fee:"8,000〜15,000円",age:"1歳半〜",skills:"リスニング・発音・異文化理解",desc:"幼少期からの英語教育は発音やリスニング力の向上に効果的。千里中央エリアに大手英会話教室が集まっています。"},
  ...
  "学習塾":{fee:"7,000〜33,000円",age:"3歳〜",skills:"基礎学力・自学力・思考力・受験対策",desc:"公文式や学研教室の基礎学力から、馬渕教室のような難関受験対策まで。北摂エリアは教育熱心な家庭が多く選択肢が豊富です。"},
};

const AREAS=[{n:"箕面",c:25},{n:"船場",c:15},{n:"牧落",c:18},{n:"萱野",c:12},{n:"桜井",c:8},{n:"森町",c:6},{n:"彩都",c:10}];

// ── UI Components (same as Osaka page) ──
function Stars({r,c}) {
...
export default function App(){
  ...
  useEffect(()=>{
    ...
    document.title=`箕面市の${cat}スクールおすすめ一覧【2026年】| コドモならいごと`;
    return()=>sc.remove();
  },[cat]);
  ...
  return (<div style={{fontFamily:"'Noto Sans JP','Hiragino Sans',sans-serif",background:"#f5f6fa",minHeight:"100vh"}}>
    ...
    <header style={{background:"linear-gradient(135deg,#2a7cc8,#0D47A1)",color:"#fff",position:"sticky",top:0,zIndex:100,boxShadow:"0 4px 20px rgba(0,0,0,.15)"}}><div style={{maxWidth:1100,margin:"0 auto",padding:"12px 20px",display:"flex",alignItems:"center",justifyContent:"space-between"}}><a href="/" style={{display:"flex",alignItems:"center",gap:10,textDecoration:"none",color:"inherit"}}><span style={{fontSize:26}}>🧒</span><div><div style={{fontSize:18,fontWeight:900}}>コドモならいごと</div><div style={{fontSize:10,opacity:.8}}>子供の習い事を口コミで比較</div></div></a><span style={{fontSize:12,opacity:.9}}>📍 箕面市</span></div></header>

    <nav aria-label="パンくず" style={{maxWidth:1100,margin:"0 auto",padding:"12px 20px"}}><div style={{fontSize:12,color:"#888"}}><a href="#" style={{color:"#2a7cc8",textDecoration:"none"}}>トップ</a> › <a href="#" style={{color:"#2a7cc8",textDecoration:"none"}}>{cat}</a> › <a href="#" style={{color:"#2a7cc8",textDecoration:"none"}}>大阪府</a> › <span style={{color:"#666"}}>箕面市</span></div></nav>

    <div style={{maxWidth:1100,margin:"0 auto",padding:"0 20px"}}><div style={{background:"linear-gradient(135deg,#E8F5E9,#C8E6C9,#E3F2FD)",borderRadius:20,padding:"28px 24px",position:"relative",overflow:"hidden"}}>
      <div style={{position:"absolute",right:-10,top:-10,fontSize:100,opacity:.1,transform:"rotate(-15deg)"}}>{catData?.icon}</div>
      <h1 style={{fontSize:22,fontWeight:900,color:"#1a1a2e",lineHeight:1.4,margin:0}}>箕面市の<span style={{color:"#2E7D32"}}>{cat}スクール</span><br/>おすすめ一覧<span style={{fontSize:13,fontWeight:400,color:"#888"}}>【2026年最新】</span></h1>
      <p style={{fontSize:13,color:"#666",marginTop:8,lineHeight:1.6}}>北摂エリアの教育熱心な街・箕面市。リディアダンスアカデミーをはじめ人気教室の口コミ・料金を比較。</p>
    ...
    <nav style={{maxWidth:1100,margin:"0 auto",padding:"18px 20px 0"}}>
      ...
      <div style={{display:"flex",gap:7,overflowX:"auto",paddingBottom:8}}>
        {CATS.map(c=><button key={c.name} onClick={()=>{setCat(c.name);setSearch("");}} style={{display:"inline-flex",alignItems:"center",gap:5,padding:"7px 14px",borderRadius:24,whiteSpace:"nowrap",cursor:"pointer",border:cat===c.name?"2px solid #2E7D32":"2px solid #e8e8e8",background:cat===c.name?"linear-gradient(135deg,#2E7D32,#1B5E20)":"#fff",color:cat===c.name?"#fff":"#555",fontWeight:cat===c.name?700:500,fontSize:13,transition:"all .2s",boxShadow:cat===c.name?"0 4px 12px rgba(46,125,50,.3)":"none"}}><span>{c.icon}</span><span>{c.name}</span><span style={{fontSize:11,opacity:.8}}>({c.count})</span></button>)}
      </div>
    </nav>
    ...
    <div style={{maxWidth:1100,margin:"0 auto",padding:"18px 20px 0",display:"flex",alignItems:"center",justifyContent:"space-between"}}><div style={{fontSize:14,color:"#666"}}><span style={{fontWeight:800,fontSize:20,color:"#2E7D32"}}>{regular.length+(featured?1:0)}</span> 件のスクール</div></div>
    ...
    <section style={{background:"#f5f6fa",padding:"36px 20px"}}><div style={{maxWidth:1100,margin:"0 auto"}}>
      ...
      <FAQ q={`箕面市で人気の${cat}スクールは？`} a={`箕面市で人気の${cat}スクールは${schools.slice(0,3).map(s=>`${s.name}（${s.rating?s.rating+'点':'-'}）`).join('、')}などがあります。ぜひ体験レッスンにご参加ください。`}/>
      <FAQ q={`${cat}スクールの月謝はいくら？`} a={`箕面市の${cat}スクールの月謝相場は${info.fee}です。入会金等は各スクールにお問い合わせください。`}/>
      <FAQ q={`子どもに${cat}を習わせるメリットは？`} a={`${info.skills}などのスキルが身につきます。${info.desc}`}/>
      {cat==="ダンス"&&<FAQ q="リディアダンスアカデミーの箕面市内の教室は？" a="箕面市内には「箕面船場阪大前校」（ICCビル5階）、「箕面森町校」（森町中1-24-7）、「桜井校」（桜6-3-22）、「坊島校」（箕面市坊島）、「彩都西校」（彩都粟生南2丁目）、「箕面市立第二中学校」（萱野1丁目15-12）の6校があります。初回体験無料です。"/>}
    </div></section>
