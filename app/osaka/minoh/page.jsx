...
const S = {
  "ダンス": [
    { id:"d0",name:"リディアダンスアカデミー",rating:4.8,rc:45,age:"3歳〜15歳",featured:true,url:"https://re-dia.jp/",
      desc:"初心者クラスが充実した3歳から学べるキッズダンススクール。現役プロダンサー講師100名以上在籍。全国46校展開。箕面エリアに5校を構え、地域密着で子どもの成長を全力サポート。",
      tags:["初心者クラス充実","全国46校","プロ講師100名+","初回体験無料","少人数制","塾代助成カード対応"],
      genres:["ヒップホップ","ジャズ","ロック","K-POP","ブレイクダンス","ポップ","ワック","ソウル"],
      ...
      revs:[{g:"女の子",a:"3歳〜",l:"箕面船場阪大前校",t:"娘が3歳から通っています。ダンスだけでなく人としても大きく成長させていただいています。"},{g:"女の子",a:"7歳〜",l:"箕面森町校",t:"DANCEを始めてから人前で自分の思いを伝えられるようになりました。"}],
      color:"#E53935",emoji:"🏆"},
    ...
    { id:"d2",name:"セイハダンスアカデミー",rating:4.4,rc:132,age:"2歳〜15歳",desc:"パパイヤ鈴木氏監修カリキュラム。少人数制レッスンで一人ひとりを大切に指導。",courses:[{n:"キッズ（幼児）",p:null,a:"2歳〜5歳"},{n:"レギュラー（入門）",p:null,a:"6歳〜10歳"}],locs:[{n:"みのおキューズモール校",ad:"箕面市西宿1丁目17-22",st:"箕面萱野駅より徒歩3分"}],revs:[{g:"女の子",a:"4歳〜",l:"みのおキューズモール校",t:"発表会で大勢の前で踊る機会があり自信がつきました。"}],color:"#E91E63",emoji:"🌟"},
  ],
  "サッカー": [
...
const INFO = {
  "ダンス":{fee:"5,000〜10,000円",age:"3歳〜",skills:"リズム感・柔軟性・集中力・協調性",desc:"中学校で必修化されたダンス。箕面エリアではリディアダンスアカデミーが5校を展開し、初心者クラスが充実。発表会は大きな会場で開催され、お子様の成長を実感できます。"},
...
function LocRow({l,color,last}) {
  return (
    <div style={{padding:"8px 0",borderBottom:last?"none":"1px solid #f0f0f0"}}>
      <div style={{fontSize:13,fontWeight:700,color:"#333"}}>📍 {l.n}</div>
      <div style={{fontSize:11,color:"#888",marginTop:2}}>{l.ad}</div>
      <div style={{fontSize:11,color:color,marginTop:2}}>🚃 {l.st}</div>
    </div>
  );
}
...
export default function App(){
  ...
  return (<div style={{fontFamily:"'Noto Sans JP','Hiragino Sans',sans-serif",background:"#f5f6fa",minHeight:"100vh"}}>
    ...
    <section style={{background:"#f5f6fa",padding:"36px 20px"}}><div style={{maxWidth:1100,margin:"0 auto"}}>
      ...
      {cat==="ダンス"&&<FAQ q="リディアダンスアカデミーの箕面市内の教室は？" a="箕面市内には「箕面船場阪大前校」（ICCビル5階）、「箕面森町校」（森町中1-24-7）、「桜井校」（桜6-3-22）、「彩都西校」（彩都粟生南2丁目）、「箕面市立第二中学校」の5校があります。初回体験無料です。"/>}
    </div></section>
