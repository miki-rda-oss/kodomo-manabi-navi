...
const S = {
  "ダンス": [
    { id:"d0",name:"リディアダンスアカデミー",rating:4.8,rc:45,age:"3歳〜15歳",featured:true,url:"https://re-dia.jp/",
      desc:"初心者クラスが充実した3歳から学べるキッズダンススクール。現役プロダンサー講師100名以上在籍。全国46校展開。",
      ...
      locs:[{n:"都島校",ad:"大阪市都島区都島本通3-18-4 サニータウン日新205号",st:"都島駅より徒歩3分"},{n:"平野校",ad:"大阪市平野区平野宮町1-4-17 B1階",st:"平野駅より徒歩5分"},{n:"あべの校",ad:"大阪市阿倍野区阿倍野筋1丁目",st:"天王寺駅より徒歩3分"},{n:"福島野田校",ad:"大阪市福島区玉川4-15-11 タマガワファーストビル4F",st:"JR野田駅より徒歩3分"},{n:"福島校",ad:"大阪市福島区福島5丁目",st:"福島駅より徒歩3分"},{n:"寺田町校",ad:"大阪市天王寺区大道2丁目",st:"寺田町駅より徒歩3分"}],
      ...
      color:"#E53935",emoji:"🏆"},
    { id:"d1",name:"JDACダンススクール",rating:4.7,rc:6,age:"3歳〜15歳",desc:"生きる力が身につく教育型ダンススクール！10年以上の指導実績で独自プログラムを開発。",courses:[{n:"シャイン",p:7150,a:"3歳〜8歳"},{n:"スター",p:7370,a:"7歳〜15歳"}],locs:[{n:"あびこ校",ad:"大阪市住吉区我孫子東2-6-29",st:"あびこ駅より徒歩2分"},{n:"もりのみやキューズモール校",ad:"大阪市中央区森ノ宮中央2丁目1-70",st:"森ノ宮駅より徒歩2分"}],revs:[{g:"女の子",a:"7歳〜",l:"長居公園東校",t:"ダンスのお友達も増えて楽しそうに通っています。自信も持てるようになりました。"}],color:"#FF6B35",emoji:"💃"},
    { id:"d2",name:"セイハダンスアカデミー",rating:4.4,rc:132,age:"2歳〜15歳",desc:"パパイヤ鈴木氏監修カリキュラム。少人数制レッスンで一人ひとりを大切に指導。",courses:[{n:"キッズ（幼児）",p:null,a:"2歳〜5歳"},{n:"レギュラー（入門）",p:null,a:"6歳〜10歳"}],locs:[{n:"イオンモール大阪ドームシティ",ad:"大阪市西区千代崎3丁目13番1",st:"大正駅より徒歩3分"}],revs:[{g:"女の子",a:"4歳〜",l:"イオンモール鶴見緑地",t:"発表会で大勢の前で踊る機会があり自信がつきました。"}],color:"#E91E63",emoji:"🌟"},
  ...
  "K-POP": [
    { id:"kp0",name:"リディアダンスアカデミー",rating:4.8,rc:45,age:"3歳〜15歳",featured:true,url:"https://re-dia.jp/",
      desc:"K-POPダンスクラスも充実！初心者から経験者まで、最新のK-POP楽曲で楽しくダンス。現役プロダンサー講師100名以上在籍、全国46校展開。",
