...
export const metadata = {
  alternates: { canonical: 'https://www.kodomo-navi.com/osaka/suita' },
  ...
  openGraph: {
    ...
    url: 'https://www.kodomo-navi.com/osaka/suita',
  },
};
...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"大阪府の習い事","item":"https://www.kodomo-navi.com/osaka"},{"@type":"ListItem","position":3,"name":"吹田市の習い事","item":"https://www.kodomo-navi.com/osaka/suita"}]}` }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebPage","name":"吹田市の子供の習い事おすすめ","url":"https://www.kodomo-navi.com/osaka/suita","description":"吹田市の子ども向け習い事教室を口コミ・料金で比較。ダンス・スイミング・英語・ピアノなど人気教室の無料体験情報を掲載。","breadcrumb":{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"吹田市の習い事","item":"https://www.kodomo-navi.com/osaka/suita"}]},"publisher":{"@type":"Organization","name":"コドモならいごと","url":"https://www.kodomo-navi.com"}}` }} />
      <AreaContent />
    </>
  );
}
