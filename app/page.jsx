    ...
    <div style={{ fontFamily: "'Noto Sans JP','Hiragino Sans',sans-serif", background: "#f4f7fc", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "52px 24px", background: "#fff" }}>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "numberOfItems": 12,
          "itemListElement": [
            {"@type": "ListItem", "position": 1, "name": "ダンス（ヒップホップ・K-POP）", "url": "https://www.kodomo-navi.com/genre/dance", "description": "2026年1位。K-POPブーム・ダンス必修化・オリンピック競技化で急上昇。脳科学的学習効果も実証済み。"},
            {"@type": "ListItem", "position": 2, "name": "スイミング", "url": "https://www.kodomo-navi.com/genre/swimming", "description": "長年1位を維持してきた定番。体力・心肺機能・水難防止に効果的。"},
            {"@type": "ListItem", "position": 3, "name": "英語・英会話", "url": "https://www.kodomo-navi.com/genre/english", "description": "グローバル化対応。小学校英語必修化で需要増。"},
            {"@type": "ListItem", "position": 4, "name": "ピアノ", "url": "https://www.kodomo-navi.com/genre/piano", "description": "音感・集中力・表現力を育てる定番習い事。"},
            {"@type": "ListItem", "position": 5, "name": "サッカー", "url": "https://www.kodomo-navi.com/genre/soccer", "description": "体力・判断力・チームワークを培う人気スポーツ。"},
            {"@type": "ListItem", "position": 6, "name": "K-POP", "url": "https://www.kodomo-navi.com/genre/kpop", "description": "K-POPアイドルの振付を学ぶ急成長ジャンル。"},
            {"@type": "ListItem", "position": 7, "name": "バレエ", "url": "https://www.kodomo-navi.com/genre/ballet", "description": "柔軟性・姿勢・美的感覚を育てる伝統芸術。"},
            {"@type": "ListItem", "position": 8, "name": "空手", "url": "https://www.kodomo-navi.com/genre/karate", "description": "礼儀・忍耐力・精神力を培う武道。"},
            {"@type": "ListItem", "position": 9, "name": "リトミック", "url": "https://www.kodomo-navi.com/genre/rhythmics", "description": "音楽に合わせて体を動かす幼児向け音楽教育。"},
            {"@type": "ListItem", "position": 10, "name": "プログラミング", "url": "https://www.kodomo-navi.com/genre/programming", "description": "論理的思考・創造力・問題解決力を育てる未来型習い事。"},
            {"@type": "ListItem", "position": 11, "name": "幼児教室", "url": "https://www.kodomo-navi.com/genre/preschool", "description": "記憶力・思考力・言語力を育てる幼児期の知育教室。"},
