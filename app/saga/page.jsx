...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.kodomo-navi.com/saga' },
};
export default function PrefPage() {
  const breadcrumb = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"佐賀県の習い事","item":"https://www.kodomo-navi.com/saga"}]};
    return (
        ...
        <section style={{background:'#fff',borderRadius:16,padding:'24px 20px',border:'1.5px solid #e8edf4',marginTop:32,marginBottom:24}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
            {[
              ...
              ['/ballet/saga','🩰','バレエ'],
              ['/gymnastics/saga','🤸','体操'],
              ['/basketball/saga','🏀','バスケット'],
              ['/preschool/saga','🧒','幼児教室'],
              ['/soroban/saga','🧮','そろばん'],
              ['/programming/saga','💻','プログラミング'],
              ['/rhythmics/saga','🎵','リトミック'],
              ['/music/saga','🎸','音楽'],
              ['/karate/saga','🥋','空手'],
