...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.kodomo-navi.com/shimane' },
};
        ...
        <section style={{background:'#fff',borderRadius:16,padding:'24px 20px',border:'1.5px solid #e8edf4',marginTop:32,marginBottom:24}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:8}}>
            {[
              ['/soccer/shimane','⚽','サッカー'],
              ['/piano/shimane','🎹','ピアノ'],
              ['/swimming/shimane','🏊','スイミング'],
              ['/english/shimane','🌍','英語'],
              ['/ballet/shimane','🩰','バレエ'],
              ['/gymnastics/shimane','🤸','体操'],
              ['/basketball/shimane','🏀','バスケット'],
              ['/preschool/shimane','🧒','幼児教室'],
              ['/soroban/shimane','🧮','そろばん'],
              ['/programming/shimane','💻','プログラミング'],
              ['/rhythmics/shimane','🎵','リトミック'],
              ['/music/shimane','🎸','音楽'],
              ['/karate/shimane','🥋','空手'],
