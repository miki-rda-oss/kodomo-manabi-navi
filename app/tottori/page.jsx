...
export const metadata = {
  ...
  alternates: { canonical: 'https://kodomo-manabi-navi.vercel.app/tottori' },
};
export default function PrefPage() {
  const breadcrumb = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://kodomo-manabi-navi.vercel.app"},{"@type":"ListItem","position":2,"name":"鳥取県の習い事","item":"https://kodomo-manabi-navi.vercel.app/tottori"}]};
