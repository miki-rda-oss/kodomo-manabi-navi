...
export const metadata = {
  title: '和歌山県の子供向けダンス教室・習い事一覧｜コドモならいごと',
  description: '和歌山県内のキッズダンス教室・子ども向け習い事を市別に比較。和歌山市の教室情報を掲載。',
  keywords: ['和歌山', '子供', 'ダンス教室', '習い事', 'キッズ', '和歌山県', '比較'],
  alternates: {
    canonical: 'https://www.kodomo-navi.com/wakayama',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "和歌山県の習い事", "item": "https://www.kodomo-navi.com/wakayama" },
  ],
};
...
const collectionSchema = {
  "@context": "https://schema.org",
  "@type": "CollectionPage",
  "name": "和歌山県の子供向け習い事・ダンス教室一覧",
  "url": "https://www.kodomo-navi.com/wakayama",
  "description": "和歌山県内のキッズダンス教室・子ども向け習い事を市別に比較。和歌山市の教室情報を掲載。",
  "breadcrumb": {
    "@type": "BreadcrumbList",
    "itemListElement": [
...
const faqs = [
  { q: '和歌山県内の子供ダンス教室の月謝相場は？', a: '和歌山県の子供ダンス教室は月4,000円〜7,000円程度が相場です。都市部に比べてリーズナブルな教室が多い傾向があります。' },
  { q: '和歌山市でおすすめの子供ダンス教室は？', a: '和歌山市はリディアダンスアカデミーが展開しています。JR和歌山駅・南海和歌山市駅周辺に教室情報を掲載しています。' },
  { q: '和歌山でダンス以外の習い事情報はありますか？', a: 'はい。スイミング・英語・ピアノ・空手など幅広い習い事情報を和歌山市エリアで掲載しています。' },
  { q: '和歌山県内のエリア情報を増やす予定はありますか？', a: '田辺市・橋本市など和歌山県内の他エリアも順次情報を追加予定です。お待ちください。' },
];

const blogs = [
  { href: '/blog/wakayama-kids-dance-school-ranking', text: '和歌山で子供のダンス教室おすすめランキング【2026年版】' },
...
const faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"和歌山県内の子供ダンス教室の月謝相場は？","acceptedAnswer":{"@type":"Answer","text":"和歌山県の子供ダンス教室は月4,000円〜7,000円程度が相場です。都市部に比べてリーズナブルな教室が多い傾向があります。"}},{"@type":"Question","name":"和歌山市でおすすめの子供ダンス教室は？","acceptedAnswer":{"@type":"Answer","text":"和歌山市はリディアダンスアカデミーが展開しています。JR和歌山駅・南海和歌山市駅周辺に教室情報を掲載しています。"}},{"@type":"Question","name":"和歌山でダンス以外の習い事情報はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。スイミング・英語・ピアノ・空手など幅広い習い事情報を和歌山市エリアで掲載しています。"}},{"@type":"Question","name":"和歌山県内のエリア情報を増やす予定はありますか？","acceptedAnswer":{"@type":"Answer","text":"田辺市・橋本市など和歌山県内の他エリアも順次情報を追加予定です。お待ちください。"}}]};

export default function WakayamaPrefPage() {
  return (
    <div style={{ fontFamily: "'Noto Sans JP','Hiragino Sans',sans-serif", background: "#f4f7fc", minHeight: "100vh" }}>
      ...
      <header style={{ background: "#fff", borderBottom: "1px solid #e8edf4", boxShadow: "0 2px 8px rgba(0,0,0,.05)", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", gap: 10, height: 56 }}>
          ...
          <span style={{ fontSize: 13, color: "#888", fontWeight: 600 }}>和歌山県</span>
        </div>
      </header>
      ...
      <nav aria-label="パンくず" style={{ maxWidth: 1100, margin: "0 auto", padding: "10px 24px" }}>
        <div style={{ fontSize: 12, color: "#888" }}>
          ...
          {" › "}
          <span style={{ color: "#666" }}>和歌山県</span>
        </div>
      </nav>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A, #2a4070)", padding: "44px 24px 40px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 900, color: "#fff", marginBottom: 12 }}>和歌山県の子供向け<br />ダンス教室・習い事</h1>
          <p style={{ fontSize: 14, color: "rgba(255,255,255,.85)", lineHeight: 1.9 }}>
            紀伊半島の自然豊かな和歌山でお子さまの習い事を探そう<br />
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 18, paddingBottom: 12, borderBottom: "2px solid #FF8A0020" }}>📍 和歌山県のエリアを選ぶ</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12 }}>
            {areas.map((area) => (
              <Link key={area.slug} href={`/wakayama/${area.slug}`} style={{ display: "block", background: "#fff", border: "1.5px solid #e8edf4", borderRadius: 12, padding: "16px 18px", textDecoration: "none", color: "#1B2A4A", fontWeight: 700, fontSize: 15, boxShadow: "0 2px 8px rgba(0,0,0,.04)" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 18, paddingBottom: 12, borderBottom: "2px solid #FF8A0020" }}>❓ よくある質問（和歌山の習い事）</h2>
        ...
        <section style={{ maxWidth: 900, margin: "0 auto 40px", padding: "0 0px" }}>
          <div style={{ background: "linear-gradient(135deg, #fff7ee, #fff0f5)", borderRadius: 16, padding: "24px 20px", border: "1.5px solid #FFD9A0" }}>
            <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 12 }}>
              🥇 和歌山の習い事トレンド2026：ダンスが1位
            </h2>
            <p style={{ fontSize: 14, lineHeight: 1.9, color: "#444", marginBottom: 16 }}>
              和歌山でもキッズダンスが人気。K-POPブームと中学校ダンス必修化の影響で、和歌山でも子供のダンス習い事への需要が急増しています。
              2026年の習い事人気ランキングでダンスが1位を獲得し、スイミングや英語を上回る勢いです。
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {[
                { slug: "kids-activity-ranking-2026-latest", title: "子供習い事人気ランキング2026年最新版" },
              ].map(({ slug, title }) => (
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/wakayama', '⚽', 'サッカー'],
              ['/piano/wakayama', '🎹', 'ピアノ'],
              ['/swimming/wakayama', '🏊', 'スイミング'],
              ['/english/wakayama', '🌍', '英語'],
              ['/ballet/wakayama', '🩰', 'バレエ'],
              ['/gymnastics/wakayama', '🤸', '体操'],
              ['/basketball/wakayama', '🏀', 'バスケット'],
              ['/preschool/wakayama', '🧒', '幼児教室'],
              ['/soroban/wakayama', '🧮', 'そろばん'],
              ['/programming/wakayama', '💻', 'プログラミング'],
              ['/rhythmics/wakayama', '🎵', 'リトミック'],
              ['/music/wakayama', '🎸', '音楽'],
              ['/karate/wakayama', '🥋', '空手'],
