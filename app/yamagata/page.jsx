...
const breadcrumbSchema = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"山形県の習い事","item":"https://www.kodomo-navi.com/yamagata"}]};
const faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"山形県内の子供ダンス教室の月謝相場は？","acceptedAnswer":{"@type":"Answer","text":"山形県の子供ダンス教室は月5,000円〜8,000円程度が相場です。"}},{"@type":"Question","name":"山形県で3歳から通えるダンス教室はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。山形県内のダンス教室の多くが3歳から入会できるリトルクラスを設けています。"}},{"@type":"Question","name":"山形県の人気ダンス教室はどこですか？","acceptedAnswer":{"@type":"Answer","text":"リディアダンスアカデミーをはじめ、山形県には体験レッスン無料の人気ダンス教室が多数あります。"}}]};
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        ...
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/yamagata', '⚽', 'サッカー'],
              ['/piano/yamagata', '🎹', 'ピアノ'],
              ['/swimming/yamagata', '🏊', 'スイミング'],
              ['/english/yamagata', '🌍', '英語'],
              ['/ballet/yamagata', '🩰', 'バレエ'],
              ['/gymnastics/yamagata', '🤸', '体操'],
              ['/basketball/yamagata', '🏀', 'バスケット'],
              ['/preschool/yamagata', '🧒', '幼児教室'],
              ['/soroban/yamagata', '🧮', 'そろばん'],
              ['/programming/yamagata', '💻', 'プログラミング'],
              ['/rhythmics/yamagata', '🎵', 'リトミック'],
              ['/music/yamagata', '🎸', '音楽'],
              ['/karate/yamagata', '🥋', '空手'],
