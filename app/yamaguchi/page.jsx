...
const breadcrumbSchema = {"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"トップ","item":"https://www.kodomo-navi.com"},{"@type":"ListItem","position":2,"name":"山口県の習い事","item":"https://www.kodomo-navi.com/yamaguchi"}]};
const faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"山口県内の子供ダンス教室の月謝相場は？","acceptedAnswer":{"@type":"Answer","text":"山口県の子供ダンス教室は月5,000円〜8,000円程度が相場です。"}},{"@type":"Question","name":"山口県で3歳から通えるダンス教室はありますか？","acceptedAnswer":{"@type":"Answer","text":"はい。山口県内のダンス教室の多くが3歳から入会できるリトルクラスを設けています。"}},{"@type":"Question","name":"山口県の人気ダンス教室はどこですか？","acceptedAnswer":{"@type":"Answer","text":"リディアダンスアカデミーをはじめ、山口県には体験レッスン無料の人気ダンス教室が多数あります。"}}]};
...
const otherPrefs = [
  { href: '/osaka', name: '大阪府' },
  { href: '/tokyo', name: '東京都' },
  { href: '/miyagi', name: '宮城県' },
  { href: '/fukuoka', name: '福岡県' },
];
    ...
    <div style={{ fontFamily: "'Noto Sans JP','Hiragino Sans',sans-serif", background: "#f4f7fc", minHeight: "100vh" }}>
      ...
      <section style={{ background: "linear-gradient(135deg, #1B2A4A, #2a4070)", padding: "44px 24px 40px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 14, color: "rgba(255,255,255,.85)", lineHeight: 1.9 }}>{PREF_CITY}を中心に{PREF_NAME}全域の習い事情報を掲載。お子さまにぴったりの教室を見つけよう。</p>
        </div>
      </section>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px 60px" }}>
        ...
        <section style={{ maxWidth: 900, margin: "0 auto 40px" }}>
          <div style={{ background: "linear-gradient(135deg, #fff7ee, #fff0f5)", borderRadius: 16, padding: "24px 20px", border: "1.5px solid #FFD9A0" }}>
            ...
            <p style={{ fontSize: 14, lineHeight: 1.9, color: "#444" }}>K-POPブームと中学校ダンス必修化の影響で、{PREF_NAME}でも子供のダンス習い事への需要が急増。2026年ランキングでダンスが1位を獲得しました。</p>
          </div>
        </section>
        <div style={{ background: "#fff", borderRadius: 18, padding: "28px 24px", marginBottom: 24, border: "1.5px solid #e8edf4" }}>
          <h2 style={{ fontSize: 18, fontWeight: 900, color: "#1B2A4A", marginBottom: 16 }}>🗾 他の都道府県の習い事情報</h2>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
            {otherPrefs.map((p, i) => <Link key={i} href={p.href} style={{ display: "inline-flex", padding: "8px 16px", background: "#fff", border: "1.5px solid #e8edf4", borderRadius: 20, textDecoration: "none", color: "#1B2A4A", fontSize: 13, fontWeight: 600 }}>{p.name}</Link>)}
          </div>
        </div>
        {/* ジャンル別に探す */}
        <section style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1.5px solid #e8edf4', marginTop: 32, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {[
              ['/soccer/yamaguchi', '⚽', 'サッカー'],
              ['/piano/yamaguchi', '🎹', 'ピアノ'],
              ['/swimming/yamaguchi', '🏊', 'スイミング'],
              ['/english/yamaguchi', '🌍', '英語'],
              ['/ballet/yamaguchi', '🩰', 'バレエ'],
              ['/gymnastics/yamaguchi', '🤸', '体操'],
              ['/basketball/yamaguchi', '🏀', 'バスケット'],
              ['/preschool/yamaguchi', '🧒', '幼児教室'],
              ['/soroban/yamaguchi', '🧮', 'そろばん'],
              ['/programming/yamaguchi', '💻', 'プログラミング'],
              ['/rhythmics/yamaguchi', '🎵', 'リトミック'],
              ['/music/yamaguchi', '🎸', '音楽'],
              ['/karate/yamaguchi', '🥋', '空手'],
